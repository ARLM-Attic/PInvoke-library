	...
	public class Attachments
	{
		...
		public static int DeleteAttachmentByTid(int tid)
		{
			...
			if (reader != null)
			{
				while (reader.Read())
				{
                   File.Delete(Utils.GetMapPath(BaseConfigs.GetForumPath + "upload/" + reader["filename"].ToString()));
				}
				reader.Close();
			}
        ...
        public static void DeleteAttachmentByPid(int pid)
        {
            ...
            if (dtAttach != null)
            {
                foreach (DataRow dr in dtAttach.Rows)
                {
                    ...
                    {
                        File.Delete(Utils.GetMapPath(BaseConfigs.GetForumPath + "upload/" + dr["filename"].ToString()));
                    }
                }
            }
        ...
        public static MyAttachmentInfoCollection GetAttachmentByUid(int uid, int typeid, int pageIndex, int pageSize)
        {

            MyAttachmentInfoCollection myattachment = new MyAttachmentInfoCollection();
            if (pageIndex <= 0)
            {
                return myattachment;
            }
        ...
        public static System.Collections.ArrayList AttachTypeList()
        {
