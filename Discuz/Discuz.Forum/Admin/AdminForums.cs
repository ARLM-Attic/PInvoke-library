...
namespace Discuz.Forum
{
	...
	public class AdminForums : Forums
	{
		...
		public static string SaveForumsInf(ForumInfo __foruminfo)
		{
            ...
            Discuz.Cache.DNTCache.GetCacheService().RemoveObject("/Forum/TopicTypesOption" + __foruminfo.Fid);
            Discuz.Cache.DNTCache.GetCacheService().RemoveObject("/Forum/TopicTypesLink" + __foruminfo.Fid);
