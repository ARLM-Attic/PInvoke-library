...
namespace Discuz.Album.Pages
{
    ...
    public class usercpphotomanage : PageBase
    {
        ...
        {
            int targetAlbumId = Convert.ToInt32(DNTRequest.GetFormString("alibumList"));
            ...
            if (DTOProvider.GetAlbumInfo(targetAlbumId).Userid !=
                userid)
            {
            ...
            AlbumInfo _sourceAlbum =
                DTOProvider.GetAlbumInfo(sourceAlbumId);
            ...
            AlbumInfo _targetAlbum =
                DTOProvider.GetAlbumInfo(targetAlbumId);
        ...
        private void SetLogo()
        {
            ...
            if (photoId == -1)
                return;
            PhotoInfo _spacephotoinfo =
                DTOProvider.GetPhotoInfo(DbProvider.GetInstance().GetPhotoByID(photoId, 0, 0));
            AlbumInfo _AlbumInfo = DTOProvider.GetAlbumInfo(albumid);
