...
namespace Discuz.Album.Pages
{
    ...
    public class usercpalbummanage : PageBase
    {
...
#if NET1
        public AlbumCategoryInfoCollection albumcates;
#else
        /// <summary>
        /// 相册分类列表
        /// </summary>
        public List<AlbumCategoryInfo> albumcates; //= new Discuz.Common.Generic.List<AlbumCategoryInfo>();
#endif
        ...
        protected override void ShowPage()
        {
            ...
            albumcates = DTOProvider.GetAlbumCategory();
        ...
        private void DeleteAlbumInfo()
        {
            ...
            string errorinfo = "";
#if NET1
            PhotoInfoCollection _spacephotoinfoarray = DTOProvider.GetSpacePhotosInfo(DbProvider.GetInstance().GetSpacePhotoByAlbumID(albumid));
#else
            List<PhotoInfo> _spacephotoinfoarray =
                DTOProvider.GetSpacePhotosInfo(DbProvider.GetInstance().GetSpacePhotoByAlbumID(albumid));
#endif
            string photoidList = "";
