...
namespace Discuz.Album.Pages
{
    ...
    public class showalbum : PageBase
    {
        ...
        protected override void ShowPage()
        {
            ...
            DataTable dt = DbProvider.GetInstance().SpacePhotosList(pageSize, currentpage, album.Userid, album.Albumid);

            photolist = DTOProvider.GetSpacePhotosInfo(dt);
            ...
            //BlogProvider.UpdateAlbumViews(albumid);
        }
    }
}