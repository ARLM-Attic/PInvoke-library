...
namespace Discuz.Album.Pages
{
    ...
    public class usercpphotoadd : PageBase
    {
        ...
        protected override void ShowPage()
        {
            ...
            albumid = DNTRequest.GetQueryInt("albumid", 0);
            ...
            int currentphotisize = Data.DbProvider.GetInstance().GetPhotoSizeByUserid(userid);
            freephotosize = maxphotosize - currentphotisize;
            ...
            if (DNTRequest.IsPost())
            {
                ...
                for (int iFile = 0; iFile < files.Count; iFile++)
                {
                    ...
                    spacephotoinfo.Title = phototitle == string.Empty
                                               ? fileName.Remove(fileName.IndexOf("."), 1)
                                               : phototitle;
                    ...
                    if (FTPs.GetAlbumAttachInfo.Allowupload == 1)
                    {
                        ...
                        spacephotoinfo.Filename = FTPs.GetAlbumAttachInfo.Remoteurl+ "/" + currentdate[0] + "/" + currentdate[1] + "/" +
                                              currentdate[2] + "/" +
                                              ftpfilename;
                    ...
                    else 
                    {
                        ...
                        spacephotoinfo.Filename = "space/upload/" + currentdate[0] + "/" + currentdate[1] + "/" +
                                              currentdate[2] + "/" +
                                              Globals.UploadSpaceFile(postedFile, uploaddir, true);
                    }
