...
namespace Discuz.Album.Pages
{
    ...
    public class showphoto : PageBase
    {
...
#if NET1        
        public PhotoInfoCollection weekhotphotolist;
        public PhotoCommentInfoCollection comments;
#else
        /// <summary>
        /// 一周热门图片列表
        /// </summary>
        ...
        protected override void ShowPage()
        {
            ...
            photoid = DNTRequest.GetInt("photoid", 0);
            ...
            {
                //更新评论数
                DbProvider.GetInstance().UpdatePhotoComments(photo.Photoid, comments.Count - photo.Comments);
            }
        ...
        private void SavePhotoComment(string message)
        {
            ...
            DbProvider.GetInstance().CreatePhotoComment(pcomment);
            ...
            HttpContext.Current.Response.Redirect(
                string.Format("{0}showphoto.aspx?photoid={1}&reply=1#comments", BaseConfigs.GetForumPath, photo.Photoid));
            //SetMetaRefresh();
            //AddMsgLine("评论发表成功");
        }
    }
