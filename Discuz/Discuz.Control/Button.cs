    ...
    public class Button : Discuz.Control.WebControl, IPostBackEventHandler
    {
        ...
        protected override void Render(HtmlTextWriter output)
        {
            ...
            else
            {
                if (this.ButtontypeMode == ButtonType.Normal)
                {
                    output.Write("<span><button type=\"button\" class=\"ManagerButton\" id=\"" + this.UniqueID + "\"" + buttonEnabled + " onclick=\"" + ScriptContent + "\">" + this.Text + "</button></span>");
                }

                if (this.ButtontypeMode == ButtonType.WithImage)
                {
                    output.Write("<span><button type=\"button\" class=\"ManagerButton\" id=\"" + this.UniqueID + "\"" + buttonEnabled + " onclick=\"" + ScriptContent + "\"><img src=\"" + this.ButtonImgUrl + "\"/>" + this.Text + "</button></span>");
                }
            }
