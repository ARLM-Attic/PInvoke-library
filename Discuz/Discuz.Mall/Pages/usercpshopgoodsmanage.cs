...
namespace Discuz.Mall.Pages
{
    ...
    public class usercpshopgoodsmanage : PageBase
    {
        ...
        /// 店铺商品分类id
        /// </summary>
        public int shopgoodscategoryid = 0;
        /// <summary>
        /// 推荐商品列表
        /// </summary>
        ...
        protected override void ShowPage()
        {
            ...
            shopgoodscategoryid = DNTRequest.GetInt("shopgoodscategoryid", 0);
            ...
            {
                reccount = Goods.GetGoodsCountByShopCategory(shopgoodscategoryid,"");
            }
                    ...
                    case "movecategory": //移动到商品分类
                        {
                            ...
                            {
                                AddErrLine("你不是当前商品的卖家，因些无法移动该商品到指定的分类");
                                return;
                            }
                            break;
                        }
                    case "removecategory": //移除商品分类
                        {
                            ...
                            {
                                AddErrLine("您不是当前商品的卖家，因些无法移除该商品的分类");
                                return;
                            }
                            break;
                        }
                    case "recommend": //推荐商品
                        {
                            ...
                            {
                                AddErrLine("您不是当前商品的卖家，因些无法推荐该商品");
                                return;
                            }
                            break;
                        }
                    case "cancelrecommend": //取消推荐商品
                        {
                            ...
                            {
                                AddErrLine("你不是当前商品的卖家，因些无法取消推荐该商品");
                                return;
                            }
                            break;
                        }
