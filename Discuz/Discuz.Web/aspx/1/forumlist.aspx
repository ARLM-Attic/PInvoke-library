...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("				if (document.getElementById('menu').style.display != 'none'){\r\n");
	templateBuilder.Append("					top.document.getElementsByTagName('FRAMESET')[0].cols = \"6,*\";\r\n");
	templateBuilder.Append("					document.getElementById('menu').style.display = 'none';\r\n");
	...
	templateBuilder.Append("					document.getElementById('menu').style.display = '';\r\n");
	templateBuilder.Append("				}\r\n");
	templateBuilder.Append("			}\r\n");
	...
	templateBuilder.Append("	<div style=\"white-space:nowrap;\" valign=\"top\">\r\n");
	...
	templateBuilder.Append("				<li>积分: <strong>" + userinfo.Credits.ToString().Trim() + "</strong>  [<span id=\"creditlist\" onMouseOver=\"showMenu(this.id, false);\" style=\"CURSOR:pointer\">详细积分</span>]\r\n");
