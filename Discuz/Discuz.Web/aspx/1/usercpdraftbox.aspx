...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2008/6/12 11:04:39.
		本页面代码由Discuz!NT模板引擎生成于 2008/6/12 11:04:39. 
	*/
	...
	templateBuilder.Append("		<a href=\"" + config.Forumurl.ToString().Trim() + "\" class=\"home\">" + config.Forumtitle.ToString().Trim() + "</a>  &raquo; <a href=\"usercp.aspx\">用户中心</a>  &raquo; <strong>草稿箱</strong>\r\n");
	templateBuilder.Append("	</div>\r\n");
	...
	templateBuilder.Append("							<td width=\"3%\"><img src=\"templates/" + templatepath.ToString() + "/images/message_" + pm.New.ToString().Trim() + ".gif\" alt=\"删除信息\"/></td>\r\n");
	...
	templateBuilder.Append("							window.location='usercpdraftbox.aspx?page=' + this.value;}\"  size=\"4\" maxlength=\"9\"/>页</kbd>\r\n");
	templateBuilder.Append("							</div>\r\n");
	templateBuilder.Append("						</div>\r\n");
