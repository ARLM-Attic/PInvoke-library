...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2008/6/12 11:05:17.
		本页面代码由Discuz!NT模板引擎生成于 2008/6/12 11:05:17. 
	*/
	...
	templateBuilder.Append("		<a href=\"" + config.Forumurl.ToString().Trim() + "\" class=\"home\">" + config.Forumtitle.ToString().Trim() + "</a>  &raquo; <a href=\"usercp.aspx\">用户中心</a>  &raquo; <strong>转账与兑换记录</strong>\r\n");
	templateBuilder.Append("	</div>\r\n");
	...
	templateBuilder.Append("								<a href=\"" + aspxrewriteurl.ToString() + "\" target=\"_blank\">" + creditslog["touser"].ToString().Trim() + "</a>\r\n");
	...
	templateBuilder.Append("								<a href=\"" + aspxrewriteurl.ToString() + "\" target=\"_blank\">" + creditslog["fromuser"].ToString().Trim() + "</a>\r\n");

	}	//end if

	templateBuilder.Append("						  </td>\r\n");
	templateBuilder.Append("                          <td width=\"20%\">" + creditslog["paydate"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("                          <td width=\"20%\">" + creditslog["send"].ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("                          <td width=\"20%\">" + creditslog["receive"].ToString().Trim() + "</td>\r\n");
	...
	templateBuilder.Append("							window.location='usercpcreaditstransferlog.aspx?page=' + this.value;}\"  size=\"4\" maxlength=\"9\"/>页</kbd>\r\n");
	templateBuilder.Append("							</div>\r\n");
	templateBuilder.Append("						</div>\r\n");
