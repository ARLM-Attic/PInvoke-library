...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2008/6/12 11:04:47.
		本页面代码由Discuz!NT模板引擎生成于 2008/6/12 11:04:47. 
	*/
	...
	templateBuilder.Append("		<a href=\"" + config.Forumurl.ToString().Trim() + "\">" + config.Forumtitle.ToString().Trim() + "</a>  &raquo; <a href=\"usercp.aspx\">用户中心</a>  &raquo; <strong>我的主题</strong>\r\n");
	templateBuilder.Append("	</div>\r\n");
	templateBuilder.Append("</div>\r\n");
	templateBuilder.Append("<!--body-->\r\n");
	templateBuilder.Append("<script type=\"text/javascript\">\r\n");
	...
	templateBuilder.Append("							<th width=\"50%\" style=\"text-align:left;\">标题</th>\r\n");
	...
	templateBuilder.Append("							<td width=\"3%\">\r\n");
	...
	templateBuilder.Append("<img src=\"images/posticons/" + topic.Iconid.ToString().Trim() + ".gif\"/>\r\n");
	...
	templateBuilder.Append("</td>\r\n");
	templateBuilder.Append("							<td width=\"50%\" style=\"text-align:left;\"><a href=\"" + aspxrewriteurl.ToString() + "\" target=\"_blank\">" + topic.Title.ToString().Trim() + "</a></td>\r\n");
	...
	templateBuilder.Append("<a href=\"" + aspxrewriteurl.ToString() + "\" target=\"_blank\">" + topic.Lastposter.ToString().Trim() + "</a>\r\n");
	...
	templateBuilder.Append("									window.location='mytopics.aspx?page='+this.value;}\"  size=\"4\" maxlength=\"9\" class=\"colorblue2\"/>页</kbd>\r\n");
	templateBuilder.Append("							</div>\r\n");
	templateBuilder.Append("						</div>\r\n");
