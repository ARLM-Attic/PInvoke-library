...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2008/6/12 11:04:56.
		本页面代码由Discuz!NT模板引擎生成于 2008/6/12 11:04:56. 
	*/
	...
	templateBuilder.Append("	     &raquo; <a href=\"" + aspxrewriteurl.ToString() + "\">" + topictitle.ToString() + "</a> &raquo; <strong>交易信息</strong>\r\n");
	templateBuilder.Append("	</div>\r\n");
	templateBuilder.Append("</div>\r\n");
	...
	templateBuilder.Append("		<table cellpadding=\"0\" cellspacing=\"0\" border=\"0\" summary=\"购买主题\">\r\n");
	...
	templateBuilder.Append("			<a href=\"" + aspxrewriteurl.ToString() + "\">" + poster.ToString() + "</a>\r\n");
	templateBuilder.Append("			</td>\r\n");
	templateBuilder.Append("		</tr>\r\n");
	templateBuilder.Append("		</tbody>\r\n");
	templateBuilder.Append("		<tbody>\r\n");
	...
	templateBuilder.Append("			<a href=\"" + aspxrewriteurl.ToString() + "\">" + topictitle.ToString() + "</a>\r\n");
	templateBuilder.Append("			</td>\r\n");
	templateBuilder.Append("		</tr>\r\n");
	templateBuilder.Append("		</tbody>\r\n");
	templateBuilder.Append("		<tbody>\r\n");
	templateBuilder.Append("		<tr>\r\n");
	templateBuilder.Append("			<th>售价(" + userextcreditsinfo.Name.ToString().Trim() + "):</th>\r\n");
	templateBuilder.Append("			<td>" + topicprice.ToString() + "</td>\r\n");
	templateBuilder.Append("		</tr>\r\n");
	templateBuilder.Append("		</tbody>\r\n");
	templateBuilder.Append("		<tbody>\r\n");
	templateBuilder.Append("		<tr>\r\n");
	templateBuilder.Append("			<th>作者所得(" + userextcreditsinfo.Name.ToString().Trim() + "):</th>\r\n");
	templateBuilder.Append("			<td>" + netamount.ToString() + "</td>\r\n");
	templateBuilder.Append("		</tr>\r\n");
	templateBuilder.Append("		</tbody>\r\n");
	templateBuilder.Append("		<tbody>\r\n");
	templateBuilder.Append("		<tr>\r\n");
	templateBuilder.Append("			<th>购买后余额(" + userextcreditsinfo.Name.ToString().Trim() + "):</th>\r\n");
	templateBuilder.Append("			<td>" + userlastprice.ToString() + "</td>\r\n");
	templateBuilder.Append("		</tr>\r\n");
	templateBuilder.Append("		</tbody>\r\n");
	templateBuilder.Append("		<tbody>\r\n");
	templateBuilder.Append("		<tr>\r\n");
	...
	templateBuilder.Append("				<a href=\"" + aspxrewriteurl.ToString() + "\" target=\"_blank\">" + paymentlog["username"].ToString().Trim() + "</a>\r\n");
	templateBuilder.Append("				</th>\r\n");
	...
	templateBuilder.Append("		<div class=\"navformcommend\" style=\"border-bottom:none;\"></div>\r\n");
	...
	templateBuilder.Append("			<td>" + creditstax.ToString() + "%</td>\r\n");
	templateBuilder.Append("		</tr>\r\n");
	templateBuilder.Append("		</tbody>\r\n");
	templateBuilder.Append("		<tbody>\r\n");
	templateBuilder.Append("		<tr>\r\n");
	...
	templateBuilder.Append("			<td>" + buyers.ToString() + "</td>\r\n");
	templateBuilder.Append("		</tr>\r\n");
	templateBuilder.Append("		</tbody>\r\n");
	templateBuilder.Append("		<tbody>\r\n");
	templateBuilder.Append("		<tr>\r\n");
	templateBuilder.Append("			<th>作者最高收入(" + userextcreditsinfo.Name.ToString().Trim() + ")</th>\r\n");
	templateBuilder.Append("			<td>" + maxincpertopic.ToString() + "</td>\r\n");
	templateBuilder.Append("		</tr>\r\n");
	templateBuilder.Append("		</tbody>\r\n");
	templateBuilder.Append("		<tbody>\r\n");
	templateBuilder.Append("		<tr>\r\n");
	...
	templateBuilder.Append("			<td>" + maxchargespan.ToString() + "</td>\r\n");
	templateBuilder.Append("		</tr>\r\n");
	templateBuilder.Append("		</tbody>\r\n");
	templateBuilder.Append("		<tbody>\r\n");
	templateBuilder.Append("		<tr>\r\n");
	...
	templateBuilder.Append("			<a href=\"" + aspxrewriteurl.ToString() + "\"><strong>" + lastpost["poster"].ToString().Trim() + "</strong></a>&nbsp;&nbsp;" + lastpost["postdatetime"].ToString().Trim() + "\r\n");
	templateBuilder.Append("			</th>\r\n");
	templateBuilder.Append("		</tr>\r\n");
	templateBuilder.Append("		<tr>\r\n");
