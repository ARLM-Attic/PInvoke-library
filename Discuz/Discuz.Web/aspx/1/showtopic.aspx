...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2008/6/12 14:22:09.
		本页面代码由Discuz!NT模板引擎生成于 2008/6/12 14:22:09. 
	*/
	...
	templateBuilder.Append("				<a href=\"showtopic.aspx?topicid=" + topicid.ToString() + "&onlyauthor=1\">只看楼主</a>  \r\n");
	...
	templateBuilder.Append("							<div class=\"t_signature\" style=\"overflow: hidden; max-height: " + heightem.ToString() + "em;maxHeightIE:" + ieheight.ToString() + "px\">" + post.Signature.ToString().Trim() + "</div>\r\n");
	...
	templateBuilder.Append("			<input name=\"topicsreset\" value=\"清空内容\" tabindex=\"6\" type=\"reset\" onclick=\"javascript:document.postform.reset(); return true; \"/>&nbsp;<input name=\"restoredata\" id=\"restoredata\" value=\"恢复数据\" tabindex=\"5\" title=\"恢复上次自动保存的数据\" onclick=\"loadData();\" type=\"button\" />\r\n");
	templateBuilder.Append("		</p>\r\n");
	templateBuilder.Append("	</div>\r\n");
