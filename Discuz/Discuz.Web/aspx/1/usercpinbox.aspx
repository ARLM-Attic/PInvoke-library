...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2008/6/12 11:04:45.
		本页面代码由Discuz!NT模板引擎生成于 2008/6/12 11:04:45. 
	*/
	...
	templateBuilder.Append("		<a href=\"" + config.Forumurl.ToString().Trim() + "\" class=\"home\">" + config.Forumtitle.ToString().Trim() + "</a>  &raquo; <a href=\"usercp.aspx\">用户中心</a>  &raquo; <strong>收件箱</strong>\r\n");
	templateBuilder.Append("	</div>\r\n");
	...
	templateBuilder.Append("							<td width=\"3%\"><img src=\"templates/" + templatepath.ToString() + "/images/message_" + pm.New.ToString().Trim() + ".gif\" alt=\"短信息\"/></td>\r\n");
	templateBuilder.Append("							<td width=\"4%\"><input name=\"pmitemid\" id=\"id" + pm.Pmid.ToString().Trim() + "\" type=\"checkbox\" value=\"" + pm.Pmid.ToString().Trim() + "\" style=\"margin-top:-1px;\"/></td>\r\n");
	...
	templateBuilder.Append("							    <a href=\"#\" onclick=\"$('id" + pm.Pmid.ToString().Trim() + "').checked=true;$('pmform').submit();\">删除</a></td>\r\n");
	...
	templateBuilder.Append("										<a href=\"###\"  onclick=\"checkCheckBox($('pmform'),this)\" class=\"selectall\">全选</a>&nbsp;&nbsp;&nbsp;\r\n");
	...
	templateBuilder.Append("																<div style=\"width:" + usedmsgbarwidth.ToString() + "%\"></div>\r\n");
	templateBuilder.Append("															</div>\r\n");
	templateBuilder.Append("														</td>\r\n");
	templateBuilder.Append("													</tr>\r\n");
	templateBuilder.Append("												</tbody>\r\n");
	...
	templateBuilder.Append("							window.location='usercpinbox.aspx?page=' + this.value;}\"  size=\"4\" maxlength=\"9\"/>页</kbd>\r\n");
	templateBuilder.Append("							</div>\r\n");
	templateBuilder.Append("						</div>\r\n");
