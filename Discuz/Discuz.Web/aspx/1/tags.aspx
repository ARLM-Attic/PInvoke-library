...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2008/6/12 11:04:13.
		本页面代码由Discuz!NT模板引擎生成于 2008/6/12 11:04:13. 
	*/
	...
	templateBuilder.Append("			<a id=\"tab_space\" \r\n");
	...
	templateBuilder.Append("spacetag-" + tagid.ToString() + ".aspx\r\n");
	...
	templateBuilder.Append(">空间</a>\r\n");
	templateBuilder.Append("			<a id=\"tab_album\" \r\n");
	...
	templateBuilder.Append("phototag-" + tagid.ToString() + ".aspx\r\n");
	...
	templateBuilder.Append(">相册</a>\r\n");
	templateBuilder.Append("			<a id=\"tab_mall\" \r\n");
	...
	templateBuilder.Append("malltag-" + tagid.ToString() + ".aspx\r\n");
	...
	templateBuilder.Append("						<tr>\r\n");
	templateBuilder.Append("							<td>\r\n");
	templateBuilder.Append("								<a href=\"" + spaceurl.ToString() + "space/viewspacepost.aspx?postid=" + post.Postid.ToString().Trim() + "\" target=\"_blank\">" + post.Title.ToString().Trim() + "</a></td>\r\n");
	templateBuilder.Append("							<td class=\"listitem\">\r\n");
	templateBuilder.Append("								<p>\r\n");
	...
	templateBuilder.Append("									<a href=\"" + aspxrewriteurl.ToString() + "\">" + post.Author.ToString().Trim() + "</a>\r\n");
	...
	templateBuilder.Append("</em>\r\n");
	templateBuilder.Append("							</td>\r\n");
	templateBuilder.Append("							<td class=\"nums\">" + post.Commentcount.ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("							<td class=\"nums\">" + post.Views.ToString().Trim() + "</td>\r\n");
	templateBuilder.Append("						</tr>\r\n");
	templateBuilder.Append("					</tbody>\r\n");
	...
	templateBuilder.Append("					<div class=\"pages\">\r\n");
	templateBuilder.Append("						<em>" + pageid.ToString() + "/" + pagecount.ToString() + "页</em>" + pagenumbers.ToString() + "\r\n");
	templateBuilder.Append("						<kbd>跳转<input name=\"gopage\" type=\"text\" id=\"gopage\" onKeyDown=\"if(event.keyCode==13) { window.location='tags.aspx?t=spacepost&tagid=" + tagid.ToString() + "&page=' + (parseInt(this.value) > 0 ? parseInt(this.value) : 1);}\" size=\"4\" maxlength=\"9\" class=\"colorblue2\"/>页</kbd>\r\n");
	templateBuilder.Append("					</div>\r\n");
	templateBuilder.Append("				</div>\r\n");
	...
	templateBuilder.Append("						<div>\r\n");
	templateBuilder.Append("							<a href=\"" + albumurl.ToString() + "showphoto.aspx?photoid=" + photo.Photoid.ToString().Trim() + "\"><img src=\"" + photo.Filename.ToString().Trim() + "\" alt=\"" + photo.Title.ToString().Trim() + "\" title=\"" + photo.Title.ToString().Trim() + "\" /></a>\r\n");
	templateBuilder.Append("						</div>\r\n");
	templateBuilder.Append("						<p>\r\n");
	templateBuilder.Append("							<script language=\"javascript\" type=\"text/javascript\">\r\n");
	templateBuilder.Append("								ShowFormatBytesStr(" + photo.Filesize.ToString().Trim() + ");\r\n");
	templateBuilder.Append("							</" + "script>\r\n");
	templateBuilder.Append("						</p>\r\n");
	templateBuilder.Append("						<p><a href=\"" + albumurl.ToString() + "showphoto.aspx?photoid=" + photo.Photoid.ToString().Trim() + "\">" + photo.Title.ToString().Trim() + "</a></p>\r\n");
	templateBuilder.Append("						</td>													\r\n");
	...
	templateBuilder.Append("					<div class=\"pages\">\r\n");
	templateBuilder.Append("						<em>" + pageid.ToString() + "/" + pagecount.ToString() + "页</em>" + pagenumbers.ToString() + "\r\n");
	templateBuilder.Append("						<kbd>跳转<input name=\"gopage\" type=\"text\" id=\"gopage\" onKeyDown=\"if(event.keyCode==13) { window.location='tags.aspx?t=photo&tagid=" + tagid.ToString() + "&page=' + (parseInt(this.value) > 0 ? parseInt(this.value) : 1);}\" size=\"4\" maxlength=\"9\" class=\"colorblue2\"/>页</kbd>\r\n");
	templateBuilder.Append("					</div>\r\n");
	templateBuilder.Append("				</div>\r\n");
	...
	templateBuilder.Append("							<img width=\"80\" src=\"templates/" + templatepath.ToString() + "/images/NoPhoto.jpg\" onerror=\"this.onerror=null;this.src='" + goodsinfo.Goodspic.ToString().Trim() + "';\"  title=\"" + goodsinfo.Title.ToString().Trim() + "\">\r\n");

	}
	else
	{

	templateBuilder.Append("							<img width=\"80\" src=\"upload/" + goodsinfo.Goodspic.ToString().Trim() + "\" onerror=\"this.onerror=null;this.src='" + goodsinfo.Goodspic.ToString().Trim() + "';\"  title=\"" + goodsinfo.Title.ToString().Trim() + "\">\r\n");
	...
	templateBuilder.Append("							<h3><a href=\"" + aspxrewriteurl.ToString() + "\" target=\"_blank\">" + goodsinfo.Htmltitle.ToString().Trim() + "</a></h3>\r\n");
	...
	templateBuilder.Append("					<div class=\"pages\">\r\n");
	templateBuilder.Append("						<em>" + pageid.ToString() + "/" + pagecount.ToString() + "页</em>" + pagenumbers.ToString() + "\r\n");
	templateBuilder.Append("						<kbd>跳转<input name=\"gopage\" type=\"text\" id=\"Text1\" onKeyDown=\"if(event.keyCode==13) { window.location='tags.aspx?t=mall&tagid=" + tagid.ToString() + "&page=' + (parseInt(this.value) > 0 ? parseInt(this.value) : 1);}\" size=\"4\" maxlength=\"9\" class=\"colorblue2\"/>页</kbd>\r\n");
	templateBuilder.Append("					</div>\r\n");
	templateBuilder.Append("				</div>\r\n");
	...
	templateBuilder.Append("			<ul id=\"forumhottags\" class=\"taglist\"><script type=\"text/javascript\" src=\"cache/hottags_forum_cache_jsonp.txt\" onerror=\"this.onerror=null;getajaxforumhottags();\"></" + "script></ul>\r\n");
	templateBuilder.Append("		</div>\r\n");
	templateBuilder.Append("		<div class=\"mainbox\">\r\n");
	templateBuilder.Append("			<h3>空间热门标签</h3>\r\n");
	templateBuilder.Append("			<ul id=\"spacehottags\" class=\"taglist\"><script type=\"text/javascript\" src=\"cache/hottags_space_cache_jsonp.txt\" onerror=\"this.onerror=null;getajaxspacehottags();\"></" + "script></ul>\r\n");
	templateBuilder.Append("		</div>\r\n");
	templateBuilder.Append("		<div class=\"mainbox\">\r\n");
	templateBuilder.Append("			<h3>图片热门标签</h3>\r\n");
	templateBuilder.Append("			<ul id=\"photohottags\" class=\"taglist\"><script type=\"text/javascript\" src=\"cache/hottags_photo_cache_jsonp.txt\" onerror=\"this.onerror=null;getajaxphotohottags();\"></" + "script></ul>\r\n");
	templateBuilder.Append("		</div>\r\n");
	templateBuilder.Append("		<div class=\"mainbox\">\r\n");
	templateBuilder.Append("			<h3>商城热门标签</h3>\r\n");
	templateBuilder.Append("			<ul id=\"mallhottags\" class=\"taglist\"><script type=\"text/javascript\" src=\"cache/hottags_mall_cache_jsonp.txt\" onerror=\"this.onerror=null;getajaxmallhottags();\"></" + "script></ul>\r\n");
	templateBuilder.Append("		</div>\r\n");
