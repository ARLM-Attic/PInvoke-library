...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2008/6/12 11:04:38.
		本页面代码由Discuz!NT模板引擎生成于 2008/6/12 11:04:38. 
	*/
	...
	templateBuilder.Append("		<a href=\"" + config.Forumurl.ToString().Trim() + "\" class=\"home\">" + config.Forumtitle.ToString().Trim() + "</a>  &raquo; <a href=\"usercp.aspx\">用户中心</a>  &raquo; <strong>积分兑换</strong>\r\n");
	templateBuilder.Append("	</div>\r\n");
	...
	templateBuilder.Append("						<div class=\"hintinfo\">充值时将根据论坛当前设置(" + creditstax.ToString() + ")扣除交易税</div>\r\n");
	templateBuilder.Append("						<input type=\"submit\" name=\"Submit\" value=\"确定\" ID=\"Submit1\"/>\r\n");
	templateBuilder.Append("						&nbsp;&nbsp;\r\n");
	templateBuilder.Append("						<input type=\"button\" name=\"Input\" value=\" 计 算 \" onclick=\"if(this.form.extcredits1.options[this.form.extcredits1.selectedIndex].value != 0 && this.form.extcredits2.options[this.form.extcredits2.selectedIndex].value != 0){alert('接收者的所得为 '+this.form.extcredits2.options[this.form.extcredits2.selectedIndex].text + ':'+Math.round(this.form.paynum.value*(creditsrate[this.form.extcredits1.options[this.form.extcredits1.selectedIndex].value]/creditsrate[this.form.extcredits2.options[this.form.extcredits2.selectedIndex].value] *(1-" + creditstax.ToString() + "))*100)/100)}else{alert('请完整填写和选择进行兑换的积分!')}\"/>\r\n");
	templateBuilder.Append("						</form>\r\n");
