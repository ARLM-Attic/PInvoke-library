<%@ Page Language="C#" AutoEventWireup="true" Inherits="Discuz.Web.UI.ShowTopicsPage" %>
...
*/
	...
	/*模板0 奇数行模板*/			"<span>[<a href=\"../showforum-{2}.aspx\" title=\"{4}\">{3}</a>]<a href=\"../showtopic-{0}.aspx\" title=\"{4}\">{1}</a></span>",
	/*模板1 奇数行模板*/			"<a href=\"../showforum-{2}.aspx\" title=\"{4}\">{1}</a>",
	/*模板2 奇数行图片调用模板*/			"<img src=\"{5}\" title=\"{4}\" />",
	...
	/*模板0 偶数行模板*/			"<span style=\"background-color: #ffffcc;\">[<a href=\"../showforum-{2}.aspx\" title=\"{4}\">{3}</a>]<a href=\"../showtopic-{0}.aspx\" title=\"{4}\">{1}</a></span>",
	/*模板1 偶数行模板*/			"<a href=\"../showforum-{2}.aspx\" title=\"{4}\"><b>{1}</b></a>",
	/*模板2 偶数行图片调用模板*/			"<img src=\"{5}\" title=\"{4}\" />",
	...
	/*模板0 奇数行模板*/			"<span>[<a href=\"../showforum.aspx?forumid={2}\" title=\"{4}\">{3}</a>]<a href=\"../showtopic.aspx?topicid={0}\" title=\"{4}\">{1}</a></span>",
	/*模板1 奇数行模板*/			"<a href=\"../showforum.aspx?forumid={2}\" title=\"{4}\">{1}</a>",
	/*模板2 奇数行图片调用模板*/			"<img src=\"{5}\" title=\"{4}\" />",
	/*模板3 奇数行个人空间模板*/		"<a href=\"{6}\" title=\"{4}\">{1}</a>",
	/*模板4 奇数行个人日志模板*/		"<a href=\"{7}\" title=\"{4}\">{1}</a>",
	/*模板5 奇数行相册模板*/		"<a href=\"{8}\" title=\"{4}\">{1}</a>"
							};
            AlternatingTemplates = new string[] {
	/*模板0 偶数行模板*/			"<span style=\"background-color: #ffffcc;\">[<a href=\"../showforum.aspx?forumid={2}\" title=\"{4}\">{3}</a>]<a href=\"../showtopic.aspx?topicid={0}\" title=\"{4}\">{1}</a></span>",
	/*模板1 偶数行模板*/			"<a href=\"../showforum.aspx?forumid={2}\" title=\"{4}\"><b>{1}</b></a>",
	/*模板2 偶数行图片调用模板*/			"<img src=\"{5}\" title=\"{4}\" />",
	/*模板3 偶数行个人空间模板*/		"<a href=\"{6}\" title=\"{4}\">{1}</a>",
	/*模板4 偶数行个人日志模板*/		"<a href=\"{7}\" title=\"{4}\">{1}</a>",
	/*模板5 偶数行相册模板*/		"<a href=\"{8}\" title=\"{4}\">{1}</a>"
        ...
        try
        {
            ...
            <param name="ordertype">排序类型，0为id倒序(TopicOrderType.ID)、1为访问量倒序(TopicOrderType.Views)、2为最后回复排序(TopicOrderType.LastPost)</param>
            ...
            */
            switch (agg)
            {
                ...
                default:
                    ...
                    ForumInfo info = Forums.GetForumInfo(fid);
                    if (info.Password=="" && (fid == 0 || info.Viewperm == null || info.Viewperm == string.Empty || (info != null && Utils.InArray(usergroupid.ToString(), info.Viewperm)) ))
                    {
                        dt = Focuses.GetTopicList(count, views, fid, timeType, orderType, isDigest, cachetime, onlyimg);
                    }
    ...
    private void OutPut(DataTable dt, string template, string alternatingTemplate)
    {
        ...
        foreach (DataRow dr in dt.Rows)
        {
            ...
            {
                thumbnail = Attachments.GetThumbnailByTid(Convert.ToInt32(dr["tid"]), imgMaxSize, ConvertThumbnailType(contentType));
            }
            result += string.Format((i % 2 == 0 ? template : alternatingTemplate), dr["tid"].ToString(), (length == -1 ? title : Utils.GetSubString(title, length, "")), forum.Fid, forum.Name, title, thumbnail);
            i++;
        }
