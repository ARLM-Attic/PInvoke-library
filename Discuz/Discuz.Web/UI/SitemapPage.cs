	...
	public class SitemapPage : Page
	{
        public SitemapPage()
		{
			if (GeneralConfigs.GetConfig().Sitemapstatus == 1)
			{
                ...
                string output = Feeds.GetBaiduSitemap(GeneralConfigs.GetConfig().Sitemapttl);
                ...
                //System.Web.HttpContext.Current.Response.AppendHeader("Content-Length", output.Length.ToString());
