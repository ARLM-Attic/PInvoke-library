...
%>
    ...
    <div class="submitComment">
		...
		<p>
			<input class=colorccc id="submitinfo" name="submitinfo" onclick="javascript:submitcommentinf(<%=postid%>,<%=userid%>);" type="button" value="提交评论" >
		    &nbsp;<a href="###" onclick="expandoptions('regoptions');" >高级选项</a><br><br>
