      ...
      if (errorinfo == "") 
      {
          if (__spacecommentinfos != null)
          {
              foreach (SpaceCommentInfo __spacecommentinfo in __spacecommentinfos)
              {
                    ...
                    {
                        Response.Write("<dt><a href=\"###\" onclick=\"document.getElementById('commentcontent').value='" + (__spacecommentinfo.Author != "" ? "@" + __spacecommentinfo.Author : "") + "';\">回复</a>\r\n");
                        ...
                        Response.Write(__spacecommentinfo.Content.Replace("\r\n", "<BR />").Replace("\n", "<BR />") + "<br /><br />\r\n"); 
		            }
               } //foreach end
