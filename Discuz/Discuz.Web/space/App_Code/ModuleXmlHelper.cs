...
_DS_AddEventHandler(""resize"", _DS_AdjustIFrameHeight);";
		...
		public static ModulePref LoadModulePref(string filename)
		{
			...
			{
#if NET1
				module.Requires = new ModuleRequireCollection();
#else
		...
		/// <returns></returns>
#if NET1 
		public static UserPrefCollection LoadUserPrefs(string filename)
#else
...
#endif
    	{
...
#if NET1
			UserPrefCollection upc = new UserPrefCollection();
#else
			...
			foreach (XmlNode xmlnode in xmlnodelist)
			{
				...
				{
#if NET1
					up.EnumValues = new EnumValueCollection();
#else
		...
		/// <returns></returns>
#if NET1         
		public static string GetUserPrefsTable(UserPrefCollection defaultUserPrefs,UserPrefsSaved personalUserPrefs)
#else
