	...
	public class Spaces
	{
...
#if NET1
        public static TabInfoCollection GetTabInfoCollectionByUserID(int userid)
#else
...
#if NET1		
        public static ModuleInfoCollection GetModuleCollectionByTabId(int tabid, int uid)
#else
		...
		public static ModuleBase SetModuleBase(ModuleInfo moduleInfo)
		{
			...
			if (moduleInfo.ModuleType == ModuleType.Local)
			{
				...
				{
#if NET1
					desktopModule.UserPrefCollection = new UserPrefCollection();
#else
...
#if NET1
		public static int GetDefaultTabId(SpaceConfigInfo spaceConfig, TabInfoCollection tc)
#else
...
#if NET1
            string[] cateidArray = (string[])list.ToArray(typeof(string));
#else
