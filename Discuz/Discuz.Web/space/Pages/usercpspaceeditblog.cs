...
namespace Discuz.Space.Pages
{
    ...
    public class usercpspaceeditblog : PageBase
    {
        ...
        /// 日志所使用的标签
        /// </summary>
        public string spaceposttags = string.Empty;
        ...
        protected override void ShowPage()
        {
            ...
            if (DNTRequest.IsPost())
            {
                ...
                if (DNTRequest.GetString("DataTextarea") == "")
                {
                    AddErrLine("请您输入文章内容");
                    return;
                }
                ...
                spacepostsinfo.Title = ForumUtils.BanWordFilter(DNTRequest.GetString("title"));
                spacepostsinfo.Content = ForumUtils.BanWordFilter(DNTRequest.GetString("DataTextarea"));
            ...
            else
            {
                ...
                spacepostsinfo.Content.Replace("'", "''");
