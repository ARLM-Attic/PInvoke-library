    ...
    public class usercpspacecategoryedit : PageBase
    {
        ...
        protected override void ShowPage()
        {
            ...
            if (DNTRequest.IsPost())
            {
                ...
                spacecategoryinfo =
                    BlogProvider.GetSpaceCategoryInfo(
                        Space.Data.DbProvider.GetInstance().GetSpaceCategoryByCategoryID(categoryid));
                ...
                spacecategoryinfo.Description = DNTRequest.GetString("description");
