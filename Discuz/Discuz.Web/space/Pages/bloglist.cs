...
namespace Discuz.Space.Pages
{
    public class bloglist : PageBase
    {
        ...
        protected override void ShowPage()
        {
            ...
            //newtopiclist = AggregationFacade.ForumAggregation.GetForumTopicList("newtopic", 0, 10);

            //hottopiclist = AggregationFacade.ForumAggregation.GetForumTopicList("hottopic", 0, 10);

            newtopiclist = AggregationFacade.ForumAggregation.GetForumTopicList(10, 0, 0, TopicTimeType.All, TopicOrderType.PostDataTime, false, false);
