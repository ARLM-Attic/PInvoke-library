...
function submitcommentinf(postid,userid)
{
	...
	AjaxHelper.Updater('usercontrols/ajaxsubmitcomment.ascx','','load=true&submit=true&postid=' + postid + '&userid=' + userid + '&commentcontent=' + commentcontent + '&commentauthor='+commentauthor+'&commentemail='+commentemail+'&commenturl='+commenturl+'&vcode='+vcode,PostCommentComplete);
} 
