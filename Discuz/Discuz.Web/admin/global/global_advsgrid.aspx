...
<body>
    <form id="Form1" method="post" runat="server">
        <cc1:DataGrid ID="DataGrid1" runat="server" OnPageIndexChanged="DataGrid_PageIndexChanged" OnSortCommand="Sort_Grid">
            <Columns>
                ...
                <asp:TemplateColumn HeaderText="广告类型" SortExpression="type">
                    <ItemTemplate>
							<%# GetAdType(DataBinder.Eval(Container, "DataItem.type").ToString())%>
					</ItemTemplate>
                </asp:TemplateColumn>
        ...
        <p style="text-align:right;">
            <cc1:Button ID="DelAds" runat="server" Text="删 除" ButtonImgUrl="../images/del.gif" Enabled="false"></cc1:Button>&nbsp;&nbsp;
