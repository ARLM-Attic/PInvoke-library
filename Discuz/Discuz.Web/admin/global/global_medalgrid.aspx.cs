...
namespace Discuz.Web.Admin
{
...
#endif
    {
        ...
        protected Discuz.Control.Button Available;
        protected Discuz.Control.Button UnAvailable;
        protected Discuz.Control.Button ImportMedal;
		protected Discuz.Control.Button  SaveMedal;
        #endregion
#endif
        ...
        private void SaveMedal_Click(object send, EventArgs e)
        {
            ...
            foreach (object o in DataGrid1.GetKeyIDArray())
            {
                ...
                DatabaseProvider.GetInstance().UpdateMedal(id, name, image);
                row++;
            }
        ...
        private void Available_Click(object sender, EventArgs e)
        {
            ...
            {
                DatabaseProvider.GetInstance().SetAvailableForMedal(1, DNTRequest.GetString("medalid"));
        ...
        private void ImportMedal_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = DatabaseProvider.GetInstance().GetExistMedalList();
            ...
            for (int i = 0; i < medalFiles.Count; i++) //将未入库的勋章入库
            {
                ...
                DatabaseProvider.GetInstance().UpdateMedal(newMedalId, "Medal No." + newMedalId, medalFiles[i].ToString());
            }
            Discuz.Cache.DNTCache.GetCacheService().RemoveObject("/Forum/UI/MedalsList");
            Response.Redirect("global_medalgrid.aspx");
            #endregion
        ...
        private void UnAvailable_Click(object sender, EventArgs e)
        {
            ...
            if (DNTRequest.GetString("medalid") != "")
            {
                DatabaseProvider.GetInstance().SetAvailableForMedal(0, DNTRequest.GetString("medalid"));
