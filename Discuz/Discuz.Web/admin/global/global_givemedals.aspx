<%@ Page Language="c#" Inherits="Discuz.Web.Admin.givemedals" Codebehind="global_givemedals.aspx.cs" %>
        ...
        <div class="ManagerForm">
            <fieldset>
                ...
                <table class="datalist" id="DataGrid1" style="border-collapse: collapse;" align="center" border="1" cellspacing="0" rules="all">
                    ...
                    <cc1:Repeater ID="medallist" runat="server">
                        <ItemTemplate>
                            <tr class="mouseoutstyle" onmouseover="this.className='mouseoverstyle'" onmouseout="this.className='mouseoutstyle'">
                                ...
                                <td style="border: 1px solid rgb(234, 233, 225);" nowrap="nowrap"><%# BeGivenMedal(DataBinder.Eval(Container.DataItem,"isgiven").ToString(),DataBinder.Eval(Container.DataItem,"medalid").ToString())%></td>
                            </tr>
                        </ItemTemplate>
