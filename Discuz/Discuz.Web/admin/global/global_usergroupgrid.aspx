...
<%@ Page Language="c#" Inherits="Discuz.Web.Admin.usergroupgrid" Codebehind="global_usergroupgrid.aspx.cs" %>
...
<body>
    <form id="Form1" method="post" runat="server">
        ...
        <cc1:DataGrid ID="DataGrid1" runat="server" IsFixConlumnControls="true" OnPageIndexChanged="DataGrid_PageIndexChanged" 
            OnSortCommand="Sort_Grid" OnItemDataBound="DataGrid1_ItemDataBound">
            <Columns>
                <asp:TemplateColumn HeaderText="">
                    <itemtemplate>
						<a href="global_editusergroup.aspx?groupid=<%# DataBinder.Eval(Container, "DataItem.groupid").ToString()%>">编辑</a>
						<%# DataGrid1.LoadSelectedCheckBox(DataBinder.Eval(Container, "DataItem.groupid").ToString())%>
					</itemtemplate>
                </asp:TemplateColumn>
                <asp:TemplateColumn HeaderText="">
                    <itemtemplate>
						<a href="global_addusergroup.aspx?groupid=<%# DataBinder.Eval(Container, "DataItem.groupid").ToString()%>">添加</a>
					</itemtemplate>
                </asp:TemplateColumn>
                ...
                <asp:BoundColumn DataField="maxprice" SortExpression="maxprice" HeaderText="主题最高售价" readonly="true"></asp:BoundColumn>
