<%@ Page Language="c#" Inherits="Discuz.Web.Admin.usergroupspecialgrid" Codebehind="global_usergroupspecialgrid.aspx.cs" %>
...
<body>
    <form id="Form1" method="post" runat="server">
        <div>
            <uc1:PageInfo ID="info1" runat="server" Icon="information" Text="增加特殊用户组方法有两种:<br />方法1: 进入<a href=&quot;global_addusergroupspecial.aspx&quot;>特殊用户组添加</a>, 增加一个新的用户组,同时编辑该组的其他设置. <br />方法2: 点击下面的相关特殊用户组记录上的 &quot;添加&quot; 链接,系统会用相关特殊用户组的信息作为模板初始化&quot;添加表单&quot;,同时编辑该组的其他设置." />
            <cc1:DataGrid ID="DataGrid1" runat="server" OnPageIndexChanged="DataGrid_PageIndexChanged" OnSortCommand="Sort_Grid">
                <Columns>
                    <asp:TemplateColumn HeaderText="">
                        <itemtemplate>
							<a href="global_editusergroupspecial.aspx?groupid=<%# DataBinder.Eval(Container, "DataItem.groupid").ToString()%>">编辑</a>
						</itemtemplate>
                    </asp:TemplateColumn>
                    <asp:TemplateColumn HeaderText="">
                        <itemtemplate>
							<a href="global_addusergroupspecial.aspx?groupid=<%# DataBinder.Eval(Container, "DataItem.groupid").ToString()%>">添加</a>
						</itemtemplate>
                    </asp:TemplateColumn>
                    ...
                    <asp:BoundColumn DataField="maxprice" SortExpression="maxprice" HeaderText="主题最高售价"></asp:BoundColumn>
