                            ...
                            <td  class="panelbox" width="50%" align="left">
                                <table width="100%">
		                            ...
		                            <tr>
                                        <td>用户信息保<br />留关键字:</td>
                                        <td>
                                            <uc1:TextareaResize ID="censoruser" runat="server" cols="30" HintTopOffSet="-110"
                                                controlname="censoruser" HintTitle="提示" 
                                                HintInfo="用户在其用户信息(如用户名、昵称、自定义头衔等)中无法使用这些关键字. 每个关键字一行, 可使用通配符 &amp;quot;*&amp;quot; 如 &amp;quot;*版主*&amp;quot;(不含引号)">
                                            </uc1:TextareaResize>
                                        </td>
		                            </tr>
		                            <tr>
                                        <td>新用户注册验证:</td>
                                        <td>
                                            <cc1:RadioButtonList ID="regverify" runat="server" RepeatColumns="3" RepeatLayout="flow"  HintTitle="提示"
		                            ...
		                            <tr>
                                        <td>Email 允许地址:</td>
                                        <td>
                                            <uc1:TextareaResize ID="accessemail" runat="server" cols="30" controlname="accessemail"
                            ...
                            <td  class="panelbox" width="50%" align="right">
                                <table width="100%">
                                    ...
                                    <tr>
                                        <td>特殊 IP 注册限制:</td>
                                        <td>
                                            <uc1:TextareaResize ID="ipregctrl" runat="server" cols="30" controlname="ipregctrl"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <uc1:TextareaResize ID="rulestxt" runat="server" label="" controlname="rulestxt"
                                             cols="30" HintTitle="提示" HintInfo="注册许可协议的详细内容"></uc1:TextareaResize>
                                        </td>
                                    </tr>                                    
		                            <tr>
                                        <td>发送欢迎短消息:</td>
		                            ...
		                            <tr>
                                        <td>欢迎短消息内容:</td>
                                        <td>
                                            <uc1:TextareaResize ID="welcomemsgtxt" runat="server" cols="30" HintTopOffSet="-50"
                            ...
                            <td  class="panelbox" width="50%" align="left">
                                <table width="100%">
		                            ...
		                            <tr>
                                        <td>IP 访问列表:</td>
                                        <td>
                                            <uc1:TextareaResize ID="ipaccess" runat="server" cols="30" controlname="ipaccess"
		                    ...
		                    <td  class="panelbox" width="50%" align="right">
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td>
                                            <uc1:TextareaResize ID="ipdenyaccess" runat="server" cols="30" controlname="ipdenyaccess"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <uc1:TextareaResize ID="adminipaccess" runat="server" cols="30" controlname="adminipaccess"
