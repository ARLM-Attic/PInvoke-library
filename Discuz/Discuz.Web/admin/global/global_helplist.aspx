<%@ Page Language="C#" AutoEventWireup="false" Codebehind="global_helplist.aspx.cs" Inherits="Discuz.Web.Admin.helplist" %>
            ...
            <fieldset>
                ...
                <table width="100%" border="0">
                    ...
                    <%if (this._arrayList != null)
                      {
                          foreach (Discuz.Entity.HelpInfo hi in this._arrayList)
                          {
                              string kg = "", id;
                              if (hi.Pid == 0)
                              {
