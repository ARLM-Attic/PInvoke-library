<%@ Page Language="C#" AutoEventWireup="false" CodeBehind="global_addhelpclass.aspx.cs" Inherits="Discuz.Web.Admin.addhelpclass" %>
		    ...
		    <legend style="background:url(../images/icons/legendimg.jpg) no-repeat 6px 50%;">添加类别</legend>
			    <table class="table1" cellspacing="0" cellPadding="4" width="100%"  height="15%" align="center" >				
				    <tr>
					    ...
					    <td style="width: 300px"><cc1:TextBox id="title" runat="server" CanBeNull="必填" RequiredFieldType="暂无校验"  maxlength="249" size="50"></cc1:TextBox></td>
					    <td align="left">
