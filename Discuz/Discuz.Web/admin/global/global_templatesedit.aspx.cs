...
#if NET1
        #region 控件声明
        protected Discuz.Control.ColorPicker ColorPicker1;
        protected Discuz.Web.Admin.TextareaResize templatenew;
        protected Discuz.Control.Button SavaTemplateInfo;
        #endregion
#endif
