...
namespace Discuz.Web.Admin
{
...
#endif
    {
        ...
        protected Discuz.Control.TabPage tabPage11;
        protected Discuz.Control.TextBox userName;
        protected System.Web.UI.WebControls.CheckBox IsEditUserName;
        ...
        protected Discuz.Control.TextBox avatar;
        protected Discuz.Control.TextBox avatarwidth;
        protected Discuz.Control.TextBox avatarheight;
        ...
        protected Discuz.Control.TabPage tabPage44;
        protected Discuz.Control.Repeater medalslist;
...
#if NET1
                newsletter.Items[1].Attributes.Add("Enabled","false");
#else
        ...
        private void StopTalk_Click(object sender, EventArgs e)
        {
            ...
            if (this.CheckCookie())
            {
                ...
                if (ViewState["Groupid"].ToString() != "4") //当用户不是系统禁言组时
                {
                    ...
                    {
                        AlbumPluginProvider.GetInstance().Ban(__userinfo.Uid);
                        SpacePluginProvider.GetInstance().Ban(__userinfo.Uid);
        ...
        private void SaveUserInfo_Click(object sender, EventArgs e)
        {
            ...
            if (this.CheckCookie())
            {
                ...
                {
                    if (ViewState["Groupid"].ToString() != __userinfo.Groupid.ToString())
                    {
                        if (__userinfo.Groupid == 4)
                        {
                        ...
                        else
                        {
                            if (AlbumPluginProvider.GetInstance() != null)
                            {
                                AlbumPluginProvider.GetInstance().UnBan(__userinfo.Uid); 
                            }
                            if (SpacePluginProvider.GetInstance() != null)
                            {
                                SpacePluginProvider.GetInstance().UnBan(__userinfo.Uid);
                            }
                        }
                    }
                    if (userName.Text != ViewState["username"].ToString())
