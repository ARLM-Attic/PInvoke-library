...
namespace Discuz.Web.Admin
{
...
#endif
    {
        ...
        protected Discuz.Control.TextBox find;
        protected Discuz.Control.TextBox replacement;
        protected Discuz.Control.Button AddNewRec;
		protected Discuz.Control.Button SaveWord;
        #endregion
#endif
        ...
        public void BindData()
        {
            ...
            DataGrid1.BindData(DatabaseProvider.GetInstance().GetWords());
            #endregion
        }
        ...
        private void DelRec_Click(object sender, EventArgs e)
        {
            ...
            if (this.CheckCookie())
            {
                if (DNTRequest.GetString("id") != "")
                {
                    ...
                    DatabaseProvider.GetInstance().DeleteWords(idlist);
                    Discuz.Cache.DNTCache.GetCacheService().RemoveObject("/Forum/BanWordList");
        ...
        private void AddNewRec_Click(object sender, EventArgs e)
        {
            ...
            if (DatabaseProvider.GetInstance().ExistWord(find.Text))
            {
            ...
            try
            {
                DatabaseProvider.GetInstance().AddWord(username, find.Text, replacement.Text);
                BindData();
                Discuz.Cache.DNTCache.GetCacheService().RemoveObject("/Forum/BanWordList");
                base.RegisterStartupScript("PAGE", "window.location.href='global_wordgrid.aspx';");
                return;
