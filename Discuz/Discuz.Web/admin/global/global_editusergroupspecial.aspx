<%@ Page Language="c#" Inherits="Discuz.Web.Admin.editusergroupspecial" Codebehind="global_editusergroupspecial.aspx.cs" %>
                                    ...
                                    <td  class="panelbox" width="50%" align="left">
                                        <table width="100%">
                                            ...
                                            <tr>
                                                <td>阅读权限:</td>
                                                <td>
                                                    <cc1:TextBox ID="readaccess" runat="server" CanBeNull="可为空" RequiredFieldType="数据校验" HintInfo="设置用户浏览帖子或附件的权限级别,范围 0~255,0 为禁止用户浏览任何帖子或附件.当用户的阅读权限小于帖子或附件的阅读权限许可(默认时为 1)时,用户将不能阅读该帖子或下载该附件"
                                            ...
                                            <tr>
                                                <td>短消息最多条数:</td>
                                                <td>
                                                    <cc1:TextBox ID="maxpmnum" runat="server" CanBeNull="必填" RequiredFieldType="数据校验" HintInfo="设置用户短消息最大可保存的消息数目,0 为禁止使用短消息"
                                                        Text="0" Size="5" MaxLength="4"></cc1:TextBox>
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="SERVER" ControlToValidate="maxprice"
                                    ...
                                    <td  class="panelbox" width="50%" align="right">
                                        <table width="100%">
                                            <tr>
                                                ...
                                                <td>
                                                    <cc1:DropDownList ID="radminid" runat="server">
                                                    </cc1:DropDownList>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td>主题最高售价:</td>
                                                <td>
                                                    <cc1:TextBox ID="maxprice" runat="server" CanBeNull="必填" RequiredFieldType="数据校验" HintInfo="主题出售使得作者可以将自己发表的主题隐藏起来,只有当浏览者向作者支付相应的交易积分后才能查看主题内容.此处设置用户出售主题时允许设置的最高价格,0 为不允许用户出售."
                                                        Text="0" Size="5" MaxLength="4"></cc1:TextBox>
                                            ...
                                            <tr>
                                                <td>签名最多字节:</td>
                                                <td>
                                                    <cc1:TextBox ID="maxsigsize" runat="server" CanBeNull="必填" RequiredFieldType="数据校验" HintInfo="设置用户签名最大字节数,0 为不允许用户使用签名"
                                                        Text="0" Size="5" MaxLength="4"></cc1:TextBox>
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="SERVER" ControlToValidate="maxprice"
                                                        ErrorMessage="请输入正整数或者零" ValidationExpression="^[0-9]*$">
                                                    </asp:RegularExpressionValidator>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td>允许的评分范围:</td>
                                                <td>
                                                    <a href="#" class="TextButton" onclick="javascript:window.location.href='global_allowparticipatescore.aspx?pagename=global_editusergroupspecial&groupid=<%=Request.Params["groupid"]%>'">
                                                        编辑评分范围</a>
                                                </td>
                                            </tr>
                                        </table>
