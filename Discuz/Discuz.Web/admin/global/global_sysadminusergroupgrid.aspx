<%@ Page Language="c#" Inherits="Discuz.Web.Admin.sysadminusergroupgrid" Codebehind="global_sysadminusergroupgrid.aspx.cs" %>
        ...
        <cc1:DataGrid ID="DataGrid1" runat="server" OnPageIndexChanged="DataGrid_PageIndexChanged" OnSortCommand="Sort_Grid">
            <Columns>
                <asp:TemplateColumn HeaderText="">
                    <ItemTemplate>
						<a href="global_editsysadminusergroup.aspx?groupid=<%# DataBinder.Eval(Container, "DataItem.groupid").ToString()%>">编辑</a>
					</ItemTemplate>
                </asp:TemplateColumn>
