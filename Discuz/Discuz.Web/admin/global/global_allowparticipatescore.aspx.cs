...
namespace Discuz.Web.Admin
{
...
#endif
    {
        ...
        protected void DataGrid_Edit(Object sender, DataGridCommandEventArgs E)
        {
            ...
            {
                base.RegisterStartupScript( "", "<script>alert('操作失败,您所修改的积分行是无效的,具体操作请看注释!');window.location.href='global_allowparticipatescore.aspx?pagename=" + DNTRequest.GetString("pagename") + "&groupid=" + DNTRequest.GetString("groupid") + "';</script>");
                return;
            }
        }
