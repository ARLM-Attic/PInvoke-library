...
<%@ Page Language="c#" Inherits="Discuz.Web.Admin.addusergroupspecial" Codebehind="global_addusergroupspecial.aspx.cs" %>
                                        ...
                                        <td  class="panelbox" width="50%" align="left">
                                            <table width="100%">
                                                ...
                                                <tr>
                                                    <td>组名称颜色:</td>
                                                    <td>
                                                        <cc1:ColorPicker ID="color" runat="server" ReadOnly="True" LeftOffSet="-23" TopOffSet="-53" HintInfo="用户组名称的显示颜色">
                                                        </cc1:ColorPicker>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <cc1:TextBox ID="maxprice" runat="server" CanBeNull="必填" RequiredFieldType="数据校验"
                                                            Text="0" Size="5" MaxLength="4" HintInfo="主题出售使得作者可以将自己发表的主题隐藏起来,只有当浏览者向作者支付相应的交易积分后才能查看主题内容.此处设置用户出售主题时允许设置的最高价格,0 为不允许用户出售."></cc1:TextBox>
                                        ...
                                        <td  class="panelbox" width="50%" align="right">
                                            <table width="100%">
                                                ...
                                                <tr>
                                                    <td>阅读权限:</td>
                                                    <td>
                                                        <cc1:TextBox ID="readaccess" runat="server" CanBeNull="可为空" RequiredFieldType="数据校验" Text="0"
