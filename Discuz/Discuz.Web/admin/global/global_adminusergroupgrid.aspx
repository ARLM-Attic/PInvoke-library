<%@ Page Language="c#" Inherits="Discuz.Web.Admin.adminusergroupgrid" Codebehind="global_adminusergroupgrid.aspx.cs" %>
        ...
        <cc1:DataGrid ID="DataGrid1" runat="server" OnPageIndexChanged="DataGrid_PageIndexChanged" OnSortCommand="Sort_Grid">
            <Columns>
                <asp:TemplateColumn HeaderText="">
                    <itemtemplate>
							<a href="global_editadminusergroup.aspx?groupid=<%# DataBinder.Eval(Container, "DataItem.groupid").ToString()%>">编辑</a>
						</itemtemplate>
                </asp:TemplateColumn>
                <asp:TemplateColumn HeaderText="">
                    <ItemTemplate>
							<a href="global_addadminusergroup.aspx?groupid=<%# DataBinder.Eval(Container, "DataItem.groupid").ToString()%>">添加</a>
					</ItemTemplate>
                </asp:TemplateColumn>
