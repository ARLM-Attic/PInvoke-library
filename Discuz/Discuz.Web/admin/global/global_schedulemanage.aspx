<%@ Page Language="c#" AutoEventWireup="true" CodeBehind="global_schedulemanage.aspx.cs" Inherits="Discuz.Web.Admin.global_schedulemanage" %>
            ...
            <asp:DataGrid ID="DataGrid1" runat="server" 
                ...
                <Columns>
                    ...
                    <asp:TemplateColumn HeaderText="">
                        <ItemTemplate>
			                    <a href="global_schedulesetting.aspx?keyid=<%# DataBinder.Eval(Container, "DataItem.key").ToString()%>">编辑</a>
		                </ItemTemplate>
                    </asp:TemplateColumn>
                    <asp:TemplateColumn HeaderText="">
                        <ItemTemplate>
			                    <asp:LinkButton runat="server" ID="button" CommandName="exec" CommandArgument='<%# DataBinder.Eval(Container, "DataItem.key").ToString()%>'>立即执行</asp:LinkButton>
		                </ItemTemplate>
                    </asp:TemplateColumn>
                </Columns>
            </asp:DataGrid>
