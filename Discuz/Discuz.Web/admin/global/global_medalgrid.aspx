...
<%@ Page Language="c#" Inherits="Discuz.Web.Admin.medalgrid" Codebehind="global_medalgrid.aspx.cs" %>
            ...
            <Columns>
                <asp:TemplateColumn HeaderText="<input title='选中/取消' onclick='Check(this.form)' type='checkbox' name='chkall' id='chkall' />">
                    ...
                    <ItemTemplate>
							...
							value="<%# DataBinder.Eval(Container, "DataItem.medalid").ToString() %>" name="medalid" />
							<%# DataGrid1.LoadSelectedCheckBox(DataBinder.Eval(Container, "DataItem.medalid").ToString())%>
					</ItemTemplate>
                </asp:TemplateColumn>
                <asp:BoundColumn DataField="medalid" SortExpression="medalid" HeaderText="勋章ID" Visible="false" />
                ...
                <asp:TemplateColumn HeaderText="是否有效" SortExpression="available">
                    <ItemTemplate>
						   <%# DataBinder.Eval(Container, "DataItem.available").ToString()=="1"?"<img src=../images/ok.gif>" : "<img src=../images/cancel.gif>" %>
					</ItemTemplate>
                </asp:TemplateColumn>
                <asp:TemplateColumn HeaderText="图片">
                    <ItemTemplate>
						   <%# PicStr(DataBinder.Eval(Container, "DataItem.image").ToString())%>
					</ItemTemplate>
                </asp:TemplateColumn>
            </Columns>
        </cc1:DataGrid>
