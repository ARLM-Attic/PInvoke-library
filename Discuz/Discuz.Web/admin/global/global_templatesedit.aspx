...
<%@ Page Language="c#" Inherits="Discuz.Web.Admin.templatesedit" Codebehind="global_templatesedit.aspx.cs" %>
...
<body>
    <form id="Form1" method="post" runat="server">
	    ...
	    <p style="text-align:right;width:80%;">
	        ...
	        <button class="ManagerButton" type="button" onclick="javascript:window.location.href='global_templatetree.aspx?templateid=<%=Request.Params["templageid"]%>&path=<%=Request.Params["path"]%>&templatename=<%=Request.Params["templatename"]%>';">
