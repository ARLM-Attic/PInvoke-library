<%@ Page Language="c#" Inherits="Discuz.Web.Admin.editusergroup" Codebehind="global_editusergroup.aspx.cs" %>
                                    ...
                                    <td  class="panelbox" width="50%" align="left">
                                        <table width="100%">
                                            ...
                                            <tr>
                                                <td>积分下限:</td>
                                                <td>
                                                    <cc1:TextBox ID="creditshigher" runat="server" CanBeNull="必填" RequiredFieldType="数据校验" HintInfo="所属该用户组用户的最低积分数" Text="0" Size="10" MaxLength="9"></cc1:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>星星数:</td>
                                    ...
                                    <td  class="panelbox" width="50%" align="right">
                                        <table width="100%">
                                            ...
                                            <tr>
                                                <td>积分上限:</td>
                                                <td>
                                                    <cc1:TextBox ID="creditslower" runat="server" CanBeNull="必填" RequiredFieldType="数据校验" HintInfo="所属该用户组用户的最高积分数" Text="0" Size="10" MaxLength="9"></cc1:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>阅读权限:</td>
