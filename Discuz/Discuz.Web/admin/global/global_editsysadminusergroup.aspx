<%@ Page Language="c#" Inherits="Discuz.Web.Admin.editsysadminusergroup" EnableViewState="false" Codebehind="global_editsysadminusergroup.aspx.cs" %>
                                    ...
                                    <td  class="panelbox" width="50%" align="left">
                                        <table width="100%">
                                            ...
                                            <tr>
                                                <td>阅读权限:</td>
                                                <td>
                                                    <cc1:TextBox ID="readaccess" runat="server" CanBeNull="必填" RequiredFieldType="数据校验" Size="5" MaxLength="4" HintInfo="设置用户浏览帖子或附件的权限级别,范围 0~255,0 为禁止用户浏览任何帖子或附件.当用户的阅读权限小于帖子或附件的阅读权限许可(默认时为 1)时,用户将不能阅读该帖子或下载该附件"></cc1:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>短消息最多条数:</td>
                                    ...
                                    <td  class="panelbox" width="50%" align="right">
                                        <table width="100%">
                                            ...
                                            <tr>
                                                <td>允许的评分范围:</td>
                                                <td>
                                                    <a href="#" class="TextButton" onclick="javascript:window.location.href='global_allowparticipatescore.aspx?pagename=global_editsysadminusergroup&groupid=<%=Request.Params["groupid"]%>'">
                                                        编辑评分范围</a>
                                                </td>
                                            </tr>
                                        </table>
