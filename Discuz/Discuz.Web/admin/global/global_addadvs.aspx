<%@ Page language="c#" Inherits="Discuz.Web.Admin.addadvs" Codebehind="global_addadvs.aspx.cs" AutoEventWireup="false" %>
...
<html>
	...
	<div class="ManagerForm">
		<form id="Form1" method="post" runat="server">
            ...
            Text="<ul><li>展现方式: 帖内广告显示于帖子标题的上方, 通常使用文字的形式. 当前页面有多个帖内广告时, 系统会从中抽取与每页帖数相等的条目进行随机显示. 您可以在 Discuz!NT 选项中的其他设置中修改每帖显示的广告数量.  </ul>  <ul><li>价值分析: 由于帖子是论坛最核心的组成部分, 位于帖子内容上方的帖内广告, 便可在用户浏览帖子内容时自然的被接受, 加上随机播放的特性, 适合于特定内容的有效推广, 也可用于论坛自身的宣传和公告之用. 建议设置多条帖内广告以实现广告内容的差异化, 从而吸引更多访问者的注意力. </ul>"></uc1:PageInfo>
		    </div>
	        ...
	        <fieldset>
                    ...
                    <tr>
                        <td class="panelbox" align="left" width="50%">
                            <table width="100%">
                                ...
                                <tr>
					                <td style="width: 80px">展现方式:</td>
					                <td id="paramselect">
						                <cc1:DropDownList id="parameters" runat="server" HintTitle="提示" HintInfo="请选择所需的广告展现方式"></cc1:DropDownList>
					                </td>
                                </tr>
                                <tr>
					                <td style="width: 80px">生效时间:</td>
					                <td>
					                    <cc1:Calendar id="starttime" runat="server" HintTitle="提示" HintInfo="设置广告起始生效的时间, 格式 yyyy-mm-dd, 留空为不限制起始时间" ReadOnly="False" 
					                    ScriptPath="../js/calendar.js"></cc1:Calendar>
					                </td>
                                </tr>
                            </table>
                        </td>
                        <td  class="panelbox" align="right" width="50%">
                            <table width="100%">
				                <tr>
					                ...
					                <td>
						                <cc1:DropDownList id="type" runat="server" HintInfo="广告在前台展现的类型"></cc1:DropDownList>						
					                </td>
				                </tr>				
				                <tr>
				                ...
				                <tr>
					                ...
					                <td>
					                    <cc1:Calendar id="endtime" runat="server" HintTitle="提示" HintInfo="设置广告广告结束的时间, 格式 yyyy-mm-dd, 留空为不限制结束时间" ReadOnly="False" 
					                    ScriptPath="../js/calendar.js"></cc1:Calendar>
					                </td>
				                </tr>
                            </table>
                        ...
                        <td class="panelbox" colspan="2">
                            <table width="100%">
                                <tr>
					                ...
					                <td>
						                <cc1:TextBox id="title" runat="server" HintTitle="提示" HintInfo="广告标题只为识别辨认不同广告条目之用, 并不在广告中显示" 
			    ...
			    <table cellspacing="0" cellpadding="4" width="100%" align="center">
                    <tr>
				        ...
				        <td>
				            <img src="../images/zoomin.gif" onclick="AddWith(100)" style="cursor:hand"/>  <img src="../images/zoomout.gif" onclick="AddWith(-100)"  style="cursor:hand" />
                        ...
                        <td  class="panelbox" align="left" width="50%">
                            <table width="100%">
                                <tr>
					                ...
					                <td>
						                <cc1:TextBox id="wordcontent" runat="server" HintTitle="提示" HintInfo="请输入文字广告的显示内容" Width="200px" 
						                RequiredFieldType="暂无校验" CanBeNull="可为空"></cc1:TextBox>
						            </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td colspan="2" class="panelbox">
                            <table width="100%">
                                <tr>
					                ...
					                <td>
					                    <cc1:TextBox id="wordlink" runat="server" HintTitle="提示" HintInfo="请输入文字广告指向的 URL 链接地址, 以http://开头" Width="344px" 
					                    RequiredFieldType="暂无校验"  CanBeNull="可为空" Text=""></cc1:TextBox>
					                </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td  class="panelbox" align="left" width="50%">
                            <table width="100%">
                                <tr>
					                ...
					                <td>
						                <cc1:TextBox id="imglink" runat="server" HintTitle="提示" HintInfo="请输入图片广告指向的 URL 链接地址, 以http://开头" Width="250px" 
						                RequiredFieldType="暂无校验" CanBeNull="可为空" Text=""></cc1:TextBox>
						            </td>
                                </tr>
                                <tr>
					                <td><div id="imgwidthtxt">图片宽度:</div></td>
					                <td>
						                <cc1:TextBox id="imgwidth" runat="server" HintTitle="提示" HintInfo="请输入图片广告的宽度, 单位为像素" Width="40px" 
						                RequiredFieldType="数据校验" CanBeNull="可为空" ></cc1:TextBox> <span id="pxwidth">px</span>
					                </td>
                                </tr>
                            </table>
                        </td>
                        <td  class="panelbox" align="right" width="50%">
                            <table width="100%">
				                <tr>
					                ...
					                <td>
						                <cc1:TextBox id="imgsrc" runat="server" HintTitle="提示" HintInfo="请输入图片广告的图片调用地址, 以http://开头 建议选择640px * 130px的图片" Width="250px" 
						                RequiredFieldType="暂无校验" CanBeNull="可为空" Text=""></cc1:TextBox>
					                </td>
				                </tr>
				                <tr>
					                <td><div id="imgheighttxt">图片高度:</div></td>
					                <td>
						                <cc1:TextBox id="imgheight" runat="server" HintTitle="提示" HintInfo="请输入图片广告的高度, 单位为像素" Width="40px" 
						                RequiredFieldType="数据校验" CanBeNull="可为空"></cc1:TextBox> <span id="pxhtight">px</span>
					                </td>
				                </tr>
                            </table>
                        </td>
                        ...
                        <td colspan="2" class="panelbox">
                            <table width="100%">
                                <tr>
					                ...
					                <td>
						                <cc1:TextBox id="imgtitle" runat="server" HintTitle="提示" HintInfo="请输入图片广告的鼠标悬停文字信息" Width="344px" 
						                RequiredFieldType="暂无校验" CanBeNull="可为空"></cc1:TextBox>
					                </td>
                                </tr>
                            </table>
                        ...
                        <td  class="panelbox" align="left" width="50%">
                            <table width="100%">
                                <tr>
					                ...
					                <td>
						                <cc1:TextBox id="flashwidth" runat="server" HintTitle="提示" HintInfo="请输入 Flash 广告的宽度, 单位为像素" Width="40px" 
						                RequiredFieldType="数据校验" CanBeNull="可为空"></cc1:TextBox> px
					                </td>
                                </tr>
                            </table>
                        </td>
                        <td align="right" class="panelbox" width="50%">
                            <table width="100%">
                                <tr>
					                ...
					                <td>
						                <cc1:TextBox id="flashheight" runat="server" HintTitle="提示" HintInfo="请输入 Flash 广告的高度, 单位为像素" Width="40px" 
						                RequiredFieldType="数据校验" CanBeNull="可为空"></cc1:TextBox> px
					                </td>
                                </tr>
                            </table>
                        ...
                        <td colspan="2" class="panelbox">
                            <table width="100%">
                                <tr>
					                ...
					                <td>
						                <cc1:TextBox id="flashsrc" runat="server" HintTitle="提示" HintInfo="请输入 Flash 广告的调用地址, 以http://开头" Width="344px" 
						                RequiredFieldType="暂无校验"  CanBeNull="可为空" Text=""></cc1:TextBox>
					                </td>
                                </tr>
                            </table>
                        ...
                        <td class="panelbox">
                            <table width="100%">
                                <tr>
					                ...
					                <td>
						                <cc1:TextBox id="slwmvsrc" runat="server" HintTitle="提示" HintInfo="请输入 Wmv 广告的调用地址, 以http://开头" Width="344px" 
						                RequiredFieldType="暂无校验"  CanBeNull="可为空" Text=""></cc1:TextBox>
					                </td>
                                </tr>
                            </table>
                        ...
                        <td class="panelbox">
                            <table width="100%">
                                <tr>
					                ...
					                <td>
						                <cc1:TextBox id="slimage" runat="server" HintTitle="提示" HintInfo="请输入图片绝对地址, 以http://开头" Width="344px" 
						                RequiredFieldType="数据校验" CanBeNull="可为空"></cc1:TextBox>
					                </td>
                                </tr>
                            </table>
                        </td>
                        ...
                        <td class="panelbox">
                            <table width="100%">
                                <tr>
					                ...
					                <td>
						                <cc1:TextBox id="buttomimg" runat="server" HintTitle="提示" HintInfo="请输入图片绝对地址, 以http://开头" Width="344px" 
						                RequiredFieldType="暂无校验"  CanBeNull="可为空" Text=""></cc1:TextBox>
					                </td>
                                </tr>
                            </table>
