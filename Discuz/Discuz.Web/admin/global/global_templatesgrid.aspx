<%@ Page Language="c#" AutoEventWireup="false" Inherits="Discuz.Web.Admin.templatesgrid" Codebehind="global_templatesgrid.aspx.cs" %>
...
<body>
    <form id="Form1" method="post" runat="server">
        <uc1:PageInfo ID="info1" runat="server" Icon="information" Text="<ul><li>模板入库是将模板置为可用状态，让用户可以在前台使用此模板 </ul>  <ul><li>模板出库是将可用状态的模板置为不可用状态，用户在前台将无法继续使用此模板。注意模板出库并非将模板做物理性删除，如果以后想再次使用此模板，可以将其再次入库 <li>删除模板是将模板做物理性删除，此操作将不可恢复，请慎重使用！(列表的第一项是系统初始化模板,系统不允许删除)</ul>" />
        ...
        <p style="text-align:right;">
            ...
            <cc1:Button ID="DelTemplates" runat="server" Text=" 删 除 " Enabled="false" ButtonImgUrl="../images/state1.gif"
                OnClick="DelTemplates_Click" ScriptContent="document.getElementById('Layer5').innerHTML='<BR /><table><tr><td valign=top><img border=0 src=../images/ajax_loading.gif  /></td><td valign=middle style=font-size:14px;>正在删除选中模板, 请稍等...<BR /></td></tr></table><BR />';">
            </cc1:Button>
        </p>
    </form>
    <%=footer%>
