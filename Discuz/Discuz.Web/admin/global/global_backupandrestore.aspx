<%@ Page Language="c#" Inherits="Discuz.Web.Admin.backupandrestore" Codebehind="global_backupandrestore.aspx.cs" %>
    ...
    <div class="ManagerForm">
        <form id="Form1" method="post" runat="server">
            ...
            <cc2:DataGrid ID="Grid1" runat="server" ColumnSpan="4">
                <Columns>
                    <asp:TemplateColumn HeaderText="选择">
                        <headerstyle width="5%" />
                        <itemtemplate>
							<input id="id" onclick="javascript:SH_SelectOne(this)" type="checkbox" value="<%# DataBinder.Eval(Container, "DataItem.id").ToString() %>"	name="id" />
						</itemtemplate>
                    </asp:TemplateColumn>
            ...
            <p style="text-align:right;">
                ...
                <cc1:Button ID="DeleteBackup" runat="server" Text="删除备份" ButtonImgUrl="../images/del.gif"></cc1:Button>
            </p>
