<%@ Page Language="c#" Inherits="Discuz.Web.Admin.edituser" AutoEventWireup="false" Codebehind="global_edituser.aspx.cs" %>
                            ...
                            <table cellspacing="0" cellpadding="4" width="100%" align="center">
                                <tr>
                                    <td class="panelbox" width="50%" align="left">
                                        <table width="100%">
                                            <tr>
                                                <td style="width: 90px">积分数:</td>
                                                <td>
                                                    <cc1:TextBox ID="credits" runat="server" Width="64px" RequiredFieldType="数据校验" MaxLength="9"></cc1:TextBox>
                                                    <cc1:Button ID="CalculatorScore" runat="server" Text="以系统标准计算用户积分" ButtontypeMode="Normal">
                                                    </cc1:Button>
                                                </td>
                                            </tr>
                                            <tr>
