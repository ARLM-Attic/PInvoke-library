...
<%@ Page language="c#" Inherits="Discuz.Web.Admin.addadminusergroup" Codebehind="global_addadminusergroup.aspx.cs" %>
	...
	<body>
		<form id="Form1" runat="server">
                            ...
                            <td  class="panelbox" width="50%" align="left">
                                <table width="100%">
                                    <tr>
						                ...
						                <td><cc1:DropDownList id="radminid" runat="server" AutoPostBack="True" HintInfo="设置采用哪组管理组的基本设置"></cc1:DropDownList></td>
                                    </tr>
                                    <tr>
						                <td>组名称颜色:</td>
						                <td>
							                <cc1:ColorPicker id="color" runat="server" ReadOnly="True"  LeftOffSet="-23" TopOffSet="-53" HintInfo="用户组名称的显示颜色"></cc1:ColorPicker>
							            </td>
                                    </tr>
                                    <tr>
						                <td>阅读权限:</td>
						                <td>
							                <cc1:TextBox id="readaccess" runat="server"  CanBeNull="必填" RequiredFieldType="数据校验" Text="0" Size="5" MaxLength="4" HintInfo="设置用户浏览帖子或附件的权限级别,范围 0~255,0 为禁止用户浏览任何帖子或附件.当用户的阅读权限小于帖子或附件的阅读权限许可(默认时为 1)时,用户将不能阅读该帖子或下载该附件."></cc1:TextBox>
                                    ...
                                    <tr>
						                <td>短消息最多条数:</td>
						                <td>
							                <cc1:TextBox id="maxpmnum" runat="server" CanBeNull="必填" RequiredFieldType="数据校验" Text="0" Size="5"  MaxLength="4" HintInfo="设置用户短消息最大可保存的消息数目,0 为禁止使用短消息"></cc1:TextBox>
                                    ...
                                    <tr>
						                ...
						                <td>
							                <cc1:TextBox id="maxattachsize" runat="server"  HintInfo="设置上传单个附件允许最大字节数." HintTitle="提示" CanBeNull="必填" 
							                RequiredFieldType="数据校验" Text="0" Size="10"  MaxLength="9"></cc1:TextBox>(单位:字节)
                                    ...
                                    <tr<%=haveSpace?"":" style='display:none'"%>>
						                <td>个人空间附<br />件总字节数:</td>
						                <td>
							                <cc1:TextBox id="maxspaceattachsize" runat="server" HintInfo="设置用户在个人空间中可以上传附件的字节总数." HintTitle="提示" 
                                    ...
                                    <tr>
						                ...
						                <td>
							                ...
							                HintInfo="如果要允许所有附件类型,则不要点选右侧任何附件类型,且具体版块设置优先于用户组设置" HintTitle="提示" RepeatColumns="3"></cc1:CheckBoxList>
						                </td>
                                    </tr>
                                </table>
                            </td>
                            <td class="panelbox" width="50%" align="right">
                                <table width="100%">
					                ...
					                <tr>
						                <td>星星数:</td>
						                <td>
							                <cc1:TextBox id="stars" runat="server" CanBeNull="必填" RequiredFieldType="数据校验" Text="0" Size="5" MaxLength="4" HintInfo="该用户组显示的星星数"></cc1:TextBox>
					                ...
					                <tr>
						                <td>主题最高售价:</td>
						                <td>
							                <cc1:TextBox id="maxprice" runat="server" CanBeNull="必填" RequiredFieldType="数据校验" Text="0" Size="5" MaxLength="4" HintInfo="主题出售使得作者可以将自己发表的主题隐藏起来,只有当浏览者向作者支付相应的交易积分后才能查看主题内容.此处设置用户出售主题时允许设置的最高价格,0 为不允许用户出售."></cc1:TextBox>
					                ...
					                <tr>
						                <td>签名最多字节:</td>
						                <td>
							                <cc1:TextBox id="maxsigsize" runat="server" CanBeNull="必填" RequiredFieldType="数据校验" Text="0" Size="5"  MaxLength="4" HintInfo="设置用户签名最大字节数,0 为不允许用户使用签名"></cc1:TextBox>
					                ...
					                <tr<%=haveAlbum?"":" style='display:none'"%>>
						                <td>相册空间<br />总字节数:</td>
						                <td>
							                <cc1:TextBox id="maxspacephotosize" runat="server" HintInfo="设置用户在相册中可以上传照片的字节总数 ." HintTitle="提示" 
							                CanBeNull="必填" RequiredFieldType="数据校验" Text="0" Size="10"  MaxLength="9"></cc1:TextBox>(单位:字节)
	        ...
	        <div id="topictypes" style="display:none;width:100%;">
				<tr>
					<td class="td2">积分下限:</td>
					<td class="td2">
							<cc1:TextBox id="creditshigher" runat="server" CanBeNull="必填" RequiredFieldType="数据校验" Text="0" width="100"></cc1:TextBox></td>
				</tr>
				<tr>
					<td class="td1">积分上限:</td>
					<td class="td1">
						<cc1:TextBox id="creditslower" runat="server" CanBeNull="必填" RequiredFieldType="数据校验" Text="0" width="100"></cc1:TextBox></td>
				</tr>
				<tr>
					<td class="td1">用户组头像:</td>
					<td class="td1">
