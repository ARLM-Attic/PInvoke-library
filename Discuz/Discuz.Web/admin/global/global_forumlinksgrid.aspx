...
<%@ Page Language="c#" Inherits="Discuz.Web.Admin.forumlinksgrid" Codebehind="global_forumlinksgrid.aspx.cs" AutoEventWireup="false" %>
        ...
        <cc1:DataGrid ID="DataGrid1" runat="server" IsFixConlumnControls="true" OnPageIndexChanged="DataGrid_PageIndexChanged" OnSortCommand="Sort_Grid">
            <Columns>
                <asp:TemplateColumn HeaderText="<input title='选中/取消' onclick='Check(this.form)' type='checkbox' name='chkall' id='chkall' />">
                    ...
                    <ItemTemplate>
							<input id="delid" onclick="checkedEnabledButton(this.form,'delid','DelRec')" type="checkbox" value="<%# DataBinder.Eval(Container, "DataItem.id").ToString() %>" name="delid" />
                ...
                <asp:TemplateColumn HeaderText="图片">
                    ...
                    <ItemTemplate>
							<%# LogoStr(DataBinder.Eval(Container, "DataItem.LOGO").ToString())%>
					</ItemTemplate>
                </asp:TemplateColumn>
            </Columns>
        </cc1:DataGrid>
            ...
            <fieldset>
                ...
                <table cellspacing="0" cellpadding="4" cellspacing="4" width="100%" align="center">
                    <tr>
                        ...
                        <td>
                            <input name="name" type="text" id="name" maxlength="100" class="FormBase" onfocus="this.className='FormFocus';"
                                onblur="this.className='FormBase';" style="width: 150px;" />(必填)
                        </td>
                    </tr>
                    <tr>
                        <td style="height:35px;">链接地址:</td>
                        <td>
                            <input name="url" type="text" id="url" maxlength="100" class="FormBase" onfocus="this.className='FormFocus';"
                    ...
                    <tr>
                        ...
                        <td>
                            <input name="logo" type="text" title="当LOGO为空时，友情链接以文字方式显示" id="logo" maxlength="100"
                    ...
                    <tr>
                        ...
                        <td>
                            <input name="displayorder" type="text" title="当显示顺序为0时, 则不显示当前链接" maxlength="8" size="4"
                                id="displayorder" class="FormBase" onfocus="this.className='FormFocus';" onblur="this.className='FormBase';"
                                style="width: 50px;" value="1" maxlength="4" />(必填)
                        </td>
                    </tr>
                    <tr>
                        <td style="height:35px;">说明:</td>
                        <td>
                            <input name="note" type="text" title="当说明为空时, 友情链接以横排方式显示" id="note" maxlength="200"
                                class="FormBase" onfocus="this.className='FormFocus';" onblur="this.className='FormBase';"
                                style="width: 300px;" />
                        </td>
                    </tr>
                    <tr>
                        <td align="center" colspan="2" style="height:35px;">
                            <button type="button" class="ManagerButton" id="AddNewRec" onclick="javascript:document.form2.submit();">
                                <img src="../images/add.gif" />提 交
                            </button>&nbsp;&nbsp;&nbsp;&nbsp;
