<%@ Page language="c#" Inherits="Discuz.Web.Admin.templatevariable" Codebehind="global_templatevariable.aspx.cs" %>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <div class="ManagerForm">
	        ...
	        <table cellspacing="0" cellPadding="4" class="tabledatagrid" align="center">
			    <tr>
				    <td style="width:90px;height:35px;">变量名称:</td>
				    <td><cc2:TextBox id="variablename" runat="server" RequiredFieldType="暂无校验" width="200"></cc2:TextBox></td>
				</tr>
				<tr>
				    <td style="width:90px;height:35px;">变量值:</td>
				    <td><cc2:TextBox id="variablevalue" runat="server" RequiredFieldType="暂无校验" width="200"></cc2:TextBox></td>
			    </tr>
			    <tr>
