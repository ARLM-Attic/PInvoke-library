...
<%@ Page Language="c#" Inherits="Discuz.Web.Admin.onlinelistgrid" Codebehind="global_onlinelistgrid.aspx.cs" AutoEventWireup="false" %>
        ...
        <cc1:DataGrid ID="DataGrid1" runat="server" PageSize="10" OnCancelCommand="DataGrid_Cancel" OnEditCommand="DataGrid_Edit"
            ...
            <Columns>
                ...
                <asp:TemplateColumn HeaderText="图例显示">
                    <itemtemplate>
					   <%# GetImgLink(DataBinder.Eval(Container, "DataItem.img").ToString())%>
					</itemtemplate>
                </asp:TemplateColumn>
            </Columns>
        </cc1:DataGrid>
