<%@ Page language="c#" Inherits="Discuz.Web.Admin.shortcut" Codebehind="shortcut.aspx.cs" AutoEventWireup="false"%>
...
<html>
	...
	<body>
		...
		<table cellspacing="0" cellpadding="4" width="100%" align="center">
			...
			<tr>
				<td colspan="3">
				<button type="button" class="ManagerButton" onclick="javascript:window.open('http://nt.discuz.net/whatsnew/index.aspx?ver=<%=Utils.GetAssemblyVersion()%>&dbtype=0','','');" ><img src="../images/checkver.gif"/>检测官方最新版本</button>
				&nbsp;&nbsp;<button type="button" class="ManagerButton" onclick="javascript:window.open('http://nt.discuz.net/doc/','','');"><img src="../images/checkver.gif"/>访问官方文档中心</button>
				&nbsp;&nbsp;<button type="button" class="ManagerButton" onclick="javascript:window.open('http://nt.discuz.net/','','');" ><img src="../images/checkver.gif"/>访问官方论坛</button></td>
			</tr>
			<tr>
				<td colspan="3" height="10"><iframe  width="100%" height="100px" id="checkveriframe" framespacing="0px" style="border-width: 0px;"  frameborder="0px"  noResize ></iframe></td>
			</tr>
        </table>
		</form>
		<%=footer%>
