    ...
    public class AdminPage : Page
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            if (status != FavoriteStatus.Hidden)
            {
                ...
                {
                    headerStr += "<span align='right' id='resultmessage'>\n<a href='javascript:;' title='将该页面加入快捷操作菜单' onclick='FavoriteFunction(window.location.pathname.toLowerCase().replace(\"" + BaseConfigs.GetForumPath + "admin/\",\"\") + window.location.search.toLowerCase());' style='text-decoration:none;color:#333;' onfocus=\"this.blur();\"><img src='../images/addmenu.gif' align='absmiddle' /> 加入收藏</a>\n</span>";
                }
            }
            headerStr += "<span><a href='#' onclick='window.parent.showNavigation()' title='按ESC键或点击链接显示导航菜单' style='text-decoration:none;color:#333;'><img src='../images/navigation.gif' style='vertical-align:middle'> 管理导航</a></span>";
            headerStr += "</div>";
#if NET1                
