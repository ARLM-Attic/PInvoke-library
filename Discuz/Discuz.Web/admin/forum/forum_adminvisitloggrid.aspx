<%@ Page language="c#" Inherits="Discuz.Web.Admin.adminvisitloggrid" Codebehind="forum_adminvisitloggrid.aspx.cs" %>
    ...
    <body>
		...
		<table cellspacing="0" cellpadding="4" width="100%" align="center">
			...
			<cc1:datagrid id="DataGrid1" runat="server" OnPageIndexChanged="DataGrid_PageIndexChanged" PageSize="15" >
				<Columns>						
					 <asp:TemplateColumn HeaderText="<input title='选中/取消' onclick='Check(this.form)' type='checkbox' name='chkall' id='chkall' />">
						...
						<ItemTemplate>
							<input id="visitid" type="checkbox" name="visitid" onclick="checkedEnabledButton(this.form,'visitid','DelRec')" value="<%# DataBinder.Eval(Container, "DataItem.visitid").ToString() %>" />
						</ItemTemplate>
					</asp:TemplateColumn>					
					<asp:BoundColumn DataField="visitid" HeaderText="visitid [递增]" Visible="false" ></asp:BoundColumn>
			...
			<p style="text-align:right;">
				...
				<input title="选中/取消选中 本页所有Case" onclick="document.getElementById('chkall').click();" type="checkbox" name="chkall1" id="chkall1" />全选/取消全选
