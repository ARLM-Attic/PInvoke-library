<%@ Page language="c#" Codebehind="forum_mymenumanage.aspx.cs" AutoEventWireup="false" Inherits="Discuz.Web.Admin.mymenumanage" %>
	...
	<body>
		<form id="Form1" method="post" runat="server">
		    ...
		    <cc1:datagrid id="DataGrid1" runat="server" IsFixConlumnControls="true" OnPageIndexChanged="DataGrid_PageIndexChanged" OnSortCommand="Sort_Grid">
				<Columns>
					<asp:TemplateColumn HeaderText="<input title='选中/取消' onclick='Check(this.form)' type='checkbox' name='chkall' id='chkall' />">
						...
						<ItemTemplate>
							<input id="menuid" type="checkbox" onclick="checkedEnabledButton(this.form,'menuid','DelRec')" value="<%# DataBinder.Eval(Container, "DataItem.menuid").ToString() %>" name="menuid"/>
							<%# DataGrid1.LoadSelectedCheckBox(DataBinder.Eval(Container, "DataItem.menuid").ToString())%>
						</ItemTemplate>
					</asp:TemplateColumn>
			...
			<p style="text-align:right;">
			    ...
			    <cc1:Button id="DelRec" runat="server" Text=" 删 除 " Enabled="false" ButtonImgUrl="../images/del.gif"></cc1:Button>
			</p>
