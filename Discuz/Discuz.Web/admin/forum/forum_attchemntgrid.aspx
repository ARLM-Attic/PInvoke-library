	...
	<br />
		...
		<cc1:datagrid id="DataGrid1" runat="server" OnPageIndexChanged="DataGrid_PageIndexChanged" OnSortCommand="Sort_Grid" PageSize="20">
			...
			<p style="text-align:right;">
				<cc1:Button id="DeleteAttachment" runat="server" Text=" 删除选中的附件 " ButtonImgUrl="../images/del.gif" Enabled="false"></cc1:Button>&nbsp;&nbsp;
				<cc1:Button id="DeleteAll" runat="server" Text=" 直接全部删除 " ButtonImgUrl="../images/del.gif"></cc1:Button>
			</p>
		    </form>
			<%=footer%>		
	</body>
