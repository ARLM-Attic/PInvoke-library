...
<%@ Page language="c#" Inherits="Discuz.Web.Admin.updateforumstatic" Codebehind="forum_updateforumstatic.aspx.cs" %>
                    ...
                    <td class="panelbox">
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    每个循环更新数量:&nbsp;&nbsp;&nbsp;&nbsp;
			                        <cc1:TextBox id="pertask3" runat="server" Text="1000" RequiredFieldType="暂无校验" size="5"></cc1:TextBox>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    每个循环更新数量:&nbsp;&nbsp;
			                        <cc1:TextBox id="pertask4" runat="server" Text="500" RequiredFieldType="暂无校验" size="5"></cc1:TextBox>
                                </td>
                                <td>
                    ...
                    <td class="panelbox">
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td>
			                        开始主题TID:
			                        <cc1:TextBox id="starttid" runat="server" Text="1" RequiredFieldType="暂无校验" size="10"></cc1:TextBox><br />
			                        结束主题TID:
			                        <cc1:TextBox id="endtid" runat="server" Text="20" RequiredFieldType="暂无校验" size="10"></cc1:TextBox>
                                </td>
                                <td>
		        ...
		        <tr>
                    <td class="panelbox">
                        <table width="100%">
                            ...
                            <tr>
                                <td>更新分表最大和最小主题ID:</td>
                                <td><cc1:Button ID="UpdatePostMaxMinTid" runat="server" HintInfo="更新分表最大和最小主题ID" Text="提 交" /></td>
                            </tr>
                            <tr>
