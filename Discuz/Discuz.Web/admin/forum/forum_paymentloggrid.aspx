<%@ Page language="c#" Inherits="Discuz.Web.Admin.paymentloggrid" Codebehind="forum_paymentloggrid.aspx.cs" AutoEventWireup="false" %>
                            ...
                            <table width="100%">
                                <tr>
					                ...
					                <td>
						                ...
						                <cc4:Calendar id="postdatetimeEnd" runat="server" ReadOnly="True" ScriptPath="../js/calendar.js"></cc4:Calendar><br />
					                </td>
                                </tr>
                            </table>
                        </td>
                            ...
                            <table width="100%">
                                <tr>
					                ...
					                <td>
						                ...
						                RequiredFieldType="暂无校验" width="150"></cc2:TextBox>
					                </td>
					            </tr>
                            </table>
                        </td>
			...
			<cc1:datagrid id="DataGrid1" runat="server" OnPageIndexChanged="DataGrid_PageIndexChanged" PageSize="15" >
				<Columns>						
					...
					<asp:TemplateColumn HeaderText="作者">
						<ItemTemplate>
							<a href="../../userinfo.aspx?userid=<%# DataBinder.Eval(Container, "DataItem.authorid").ToString() %>" target="_blank">
							    <%# DataBinder.Eval(Container, "DataItem.authorname").ToString()%>
							</a>
						</ItemTemplate>
					</asp:TemplateColumn>					
					...
					<asp:TemplateColumn HeaderText="论坛">
						<ItemTemplate>
							<a href="../../showforum.aspx?forumid=<%# DataBinder.Eval(Container, "DataItem.fid").ToString()%>" target="_blank">
							    <%# DataBinder.Eval(Container, "DataItem.forumname").ToString()%>
							</a>
						</ItemTemplate>
					</asp:TemplateColumn>					
