...
<%@ Page language="c#" Inherits="Discuz.Web.Admin.editforums" Codebehind="forum_editforums.aspx.cs" AutoEventWireup="false" %>
	    ...
	    <td><br />
            ...
            <cc2:TabControl id="TabControl1" SelectionMode="Client" runat="server" TabScriptPath="../js/tabstrip.js"  height="100%">
                ...
                <cc2:TabPage Caption="特殊用户" ID="tabPage4">
                    ...
                    Text="授予某些用户在本版一些特殊权限,在下面输入框用中输入要给予特殊权限的用户列表,以&quot;,&quot;分隔"></uc1:PageInfo>
                    <table cellspacing="0" cellpadding="4" width="100%" align="center">
                        <tr>
                            <td class="panelbox" colspan="2">
                                <table width="100%">
