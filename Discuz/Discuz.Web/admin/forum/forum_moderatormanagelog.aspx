...
<%@ Page language="c#" Inherits="Discuz.Web.Admin.moderatormanagelog" Codebehind="forum_moderatormanagelog.aspx.cs" %>
        ...
        <cc1:datagrid id="DataGrid1" runat="server" OnPageIndexChanged="DataGrid_PageIndexChanged" PageSize="15" >
            <Columns>						
                ...
                <asp:TemplateColumn HeaderText="用户组">
                    <ItemTemplate>
                        <%# GroupName(DataBinder.Eval(Container, "DataItem.groupid").ToString())%>
                    </ItemTemplate>
                </asp:TemplateColumn>
