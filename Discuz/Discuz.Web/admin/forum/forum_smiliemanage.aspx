<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="forum_smiliemanage.aspx.cs" Inherits="Discuz.Web.Admin.smiliemanage" %>
		...
		<Columns>
		    <asp:TemplateColumn HeaderText="<input title='选中/取消' onclick='Check(this.form)' type='checkbox' name='chkall' id='chkall' />">
				...
				<ItemTemplate>
					...
					<%# smilesgrid.LoadSelectedCheckBox(DataBinder.Eval(Container, "DataItem.id").ToString())%>
				</ItemTemplate>
			</asp:TemplateColumn>
			...
			<asp:TemplateColumn HeaderText="操作">
				<ItemTemplate>
					<a href="forum_smilegrid.aspx?typeid=<%# DataBinder.Eval(Container, "DataItem.id").ToString() %>">管理此分类表情</a>
				</ItemTemplate>
			</asp:TemplateColumn>		
		</Columns>
	</cc1:datagrid><br />
