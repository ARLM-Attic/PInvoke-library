...
#if NET1
    public class forumtree : UserControl
#else
...
#endif
    {
...
#if NET1
        #region 控件声明
        protected System.Web.UI.WebControls.Literal TreeContent;
        #endregion
#endif
        ...
        public void LoadForumTree()
        {
            ...
            else //广告添加或编辑时显示
            {
                ...
                DataTable ad_dt = DatabaseProvider.GetInstance().GetAdvertisement(advid);
