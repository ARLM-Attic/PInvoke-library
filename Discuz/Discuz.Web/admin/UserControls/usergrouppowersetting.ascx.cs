    ...
    public class usergrouppowersetting : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                {
                    usergroupright.Items.RemoveAt(19);
                }
            }
        }
        ...
        public void Bind(UserGroupInfo usergroupinfo)
        {
            ...
            if (MallPluginProvider.GetInstance() != null && usergroupinfo.Allowtrade == 1) usergroupright.Items[19].Selected = true; //是否允许交易
        ...
        public void GetSetting(ref UserGroupInfo usergroupinfo)
        {
            ...
            if (MallPluginProvider.GetInstance() != null)
            {
                usergroupinfo.Allowtrade = usergroupright.Items[19].Selected ? 1 : 0;   //是否允许交易
            }
        }
