<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="aggregation_editforumaggset.aspx.cs" Inherits="Discuz.Web.Admin.editforumaggset" %>
        ...
        <table id="Table1" class="table1" cellspacing="0" cellpadding="4" width="100%" border="0">
			<tr>
				...
				<td>
					...
					<cc1:TextBox id="title" runat="server" RequiredFieldType="暂无校验" width="200"></cc1:TextBox></td>
			</tr>
			<tr>
				<td>发帖人:</td>
				<td>
