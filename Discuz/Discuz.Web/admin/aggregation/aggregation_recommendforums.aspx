  ...
  // End -->  
	...
	<body>
		...
		<uc1:PageInfo id="info1" runat="server" Icon="Information"
                Text="<li>第一步:选择要推荐的版块</li><li>第二步:为推荐版块设置推荐主题及图片链接</li>"></uc1:PageInfo>
        ...
        <table border="0" align="center">  
            <tr>  
                ...
                <td>  
                    <input type="button" value=">" onclick="move(this.form._ctl1,this.form.list2,0)" style="font-weight:bold;width:32" /> 
                </td>  
                <td>已选版块：<br /><select multiple="multiple" size="8" name="list2"  style="width:260px;height:290px;"></select></td>
                <td>
		...
		<div align="center">
		<cc1:Button id="Btn_SaveInfo" runat="server" Text="  下一步  " ButtonImgUrl="../images/submit.gif" ValidateForm="true"></cc1:Button>
		</div>
		</div>
		</form>
		<%=footer%>
